 ...
 *******************************************************************************/
package com.modelsolv.reprezen.rapidml.datatypes.util;
...
public class ConstraintsUtils {
    ...
    /**
     * Gets the base primitive type in type hierarchy of user defined types or from included properties. If type not
     * primitive it returns <code>null</code>.
     *
     * @param constrainableType
     *            the constrainable type
