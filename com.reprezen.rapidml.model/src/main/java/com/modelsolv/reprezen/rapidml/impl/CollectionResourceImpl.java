 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.CollectionResourceImpl#getCollectionParameters <em>Collection Parameters</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.CollectionResourceImpl#getReferenceElements <em>Reference Elements</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.CollectionResourceImpl#getResourceRealizationKind <em>Resource Realization Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionResourceImpl extends ServiceDataResourceImpl implements CollectionResource {
    ...
    public EList<CollectionParameter> getCollectionParameters() {
		if (collectionParameters == null) {
			collectionParameters = new EObjectContainmentWithInverseEList<CollectionParameter>(CollectionParameter.class, this, RapidmlPackage.COLLECTION_RESOURCE__COLLECTION_PARAMETERS, RapidmlPackage.COLLECTION_PARAMETER__CONTAINING_RESOURCE_DEFINITION);
		}
    ...
    public EList<CollectionReferenceElement> getReferenceElements() {
		if (referenceElements == null) {
			referenceElements = new EObjectContainmentEList<CollectionReferenceElement>(CollectionReferenceElement.class, this, RapidmlPackage.COLLECTION_RESOURCE__REFERENCE_ELEMENTS);
		}
    ...
    public void setResourceRealizationKind(CollectionRealizationEnum newResourceRealizationKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.COLLECTION_RESOURCE__RESOURCE_REALIZATION_KIND, oldResourceRealizationKind, resourceRealizationKind));
	}
