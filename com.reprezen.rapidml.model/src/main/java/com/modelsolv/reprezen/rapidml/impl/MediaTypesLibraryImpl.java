 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.MediaTypesLibraryImpl#getMediaTypes <em>Media Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MediaTypesLibraryImpl extends EObjectImpl implements MediaTypesLibrary {
	...
	public EList<MediaType> getMediaTypes() {
		if (mediaTypes == null) {
			mediaTypes = new EObjectContainmentEList.Unsettable<MediaType>(MediaType.class, this, RapidmlPackage.MEDIA_TYPES_LIBRARY__MEDIA_TYPES);
		}
		return mediaTypes;
	}
