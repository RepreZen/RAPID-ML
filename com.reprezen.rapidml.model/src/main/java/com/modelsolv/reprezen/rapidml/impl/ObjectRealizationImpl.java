 ...
 * </p>
 * <ul>
 * <li>{@link com.modelsolv.reprezen.rapidml.impl.ObjectRealizationImpl#getExtensions <em>Extensions</em>}</li>
 * <li>{@link com.modelsolv.reprezen.rapidml.impl.ObjectRealizationImpl#getExclusivePropertyList <em>Exclusive Property
 * List</em>}</li>
 * <li>{@link com.modelsolv.reprezen.rapidml.impl.ObjectRealizationImpl#getOverriddenPropertyList <em>Overridden
 * Property List</em>}</li>
 * <li>{@link com.modelsolv.reprezen.rapidml.impl.ObjectRealizationImpl#getExcludedProperties <em>Excluded
 * Properties</em>}</li>
 * <li>{@link com.modelsolv.reprezen.rapidml.impl.ObjectRealizationImpl#getRealizationContainer <em>Realization
 * Container</em>}</li>
 * </ul>
 *
 * @generated
...
public class ObjectRealizationImpl extends EObjectImpl implements ObjectRealization {
     ...
     * @ordered
     */
    protected EList<com.modelsolv.reprezen.rapidml.Feature> excludedProperties;
	 ...
	 * @generated
	 */
    public EList<com.modelsolv.reprezen.rapidml.Feature> getExcludedProperties() {
		if (excludedProperties == null) {
			excludedProperties = new EObjectResolvingEList<com.modelsolv.reprezen.rapidml.Feature>(com.modelsolv.reprezen.rapidml.Feature.class, this, RapidmlPackage.OBJECT_REALIZATION__EXCLUDED_PROPERTIES);
		}
    ...
    public EList<PropertyRealization> getAllIncludedProperties() {
        ...
        for (final Feature feature : dataType.getOwnedFeatures()) {
            ...
            Collection<PropertyRealization> overridden = com.google.common.collect.Collections2
                    .filter(getOverriddenPropertyList(), new com.google.common.base.Predicate<PropertyRealization>() {
                        ...
                        public boolean apply(PropertyRealization input) {
                            return com.modelsolv.reprezen.rapidml.util.InheritanceUtils
            ...
            if (!overridden.isEmpty()) {
                ...
                PropertyRealization includedProperty = com.modelsolv.reprezen.rapidml.RapidmlFactory.eINSTANCE
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RapidmlPackage.OBJECT_REALIZATION__EXCLUDED_PROPERTIES:
				...
				getExcludedProperties().addAll((Collection<? extends com.modelsolv.reprezen.rapidml.Feature>)newValue);
				return;
			case RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER:
