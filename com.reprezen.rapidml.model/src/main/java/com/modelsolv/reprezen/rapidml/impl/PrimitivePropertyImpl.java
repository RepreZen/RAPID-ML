 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.PrimitivePropertyImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.PrimitivePropertyImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitivePropertyImpl extends FeatureImpl implements PrimitiveProperty {
        ...
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RapidmlPackage.PRIMITIVE_PROPERTY__TYPE, oldType, type));
            }
        }
        return type;
    }
    ...
    public void setType(SingleValueType newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.PRIMITIVE_PROPERTY__TYPE, oldType, type));
    }
    ...
    public EList<Constraint> getConstraints() {
        if (constraints == null) {
            constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, RapidmlPackage.PRIMITIVE_PROPERTY__CONSTRAINTS);
        }
        return constraints;
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == ConstrainableType.class) {
            switch (derivedFeatureID) {
                case RapidmlPackage.PRIMITIVE_PROPERTY__CONSTRAINTS: return RapidmlPackage.CONSTRAINABLE_TYPE__CONSTRAINTS;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == ConstrainableType.class) {
            switch (baseFeatureID) {
                case RapidmlPackage.CONSTRAINABLE_TYPE__CONSTRAINTS: return RapidmlPackage.PRIMITIVE_PROPERTY__CONSTRAINTS;
                default: return -1;
            }
        }
