 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.PrimitiveTypeSourceReferenceImpl#getSimpleType <em>Simple Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeSourceReferenceImpl extends SourceReferenceImpl implements PrimitiveTypeSourceReference {
	 ...
	 * @ordered
	 */
    protected com.modelsolv.reprezen.rapidml.PrimitiveType simpleType;
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.PrimitiveType getSimpleType() {
		if (simpleType != null && simpleType.eIsProxy()) {
			InternalEObject oldSimpleType = (InternalEObject)simpleType;
			simpleType = (com.modelsolv.reprezen.rapidml.PrimitiveType)eResolveProxy(oldSimpleType);
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.PrimitiveType basicGetSimpleType() {
		return simpleType;
	}
	 ...
	 * @generated
	 */
	public void setSimpleType(com.modelsolv.reprezen.rapidml.PrimitiveType newSimpleType) {
		com.modelsolv.reprezen.rapidml.PrimitiveType oldSimpleType = simpleType;
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RapidmlPackage.PRIMITIVE_TYPE_SOURCE_REFERENCE__SIMPLE_TYPE:
				setSimpleType((com.modelsolv.reprezen.rapidml.PrimitiveType)newValue);
				return;
		}
    ...
    public void eUnset(int featureID) {
		switch (featureID) {
			case RapidmlPackage.PRIMITIVE_TYPE_SOURCE_REFERENCE__SIMPLE_TYPE:
				setSimpleType((com.modelsolv.reprezen.rapidml.PrimitiveType)null);
				return;
		}
