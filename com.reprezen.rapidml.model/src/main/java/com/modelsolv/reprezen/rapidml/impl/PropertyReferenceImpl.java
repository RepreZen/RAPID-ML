 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.PropertyReferenceImpl#getConceptualFeature <em>Conceptual Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyReferenceImpl extends SourceReferenceImpl implements PropertyReference {
	 ...
	 * @ordered
	 */
    protected com.modelsolv.reprezen.rapidml.PrimitiveProperty conceptualFeature;
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.PrimitiveProperty getConceptualFeature() {
		if (conceptualFeature != null && conceptualFeature.eIsProxy()) {
			...
			conceptualFeature = (com.modelsolv.reprezen.rapidml.PrimitiveProperty)eResolveProxy(oldConceptualFeature);
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.PrimitiveProperty basicGetConceptualFeature() {
		return conceptualFeature;
	}
	 ...
	 * @generated
	 */
	public void setConceptualFeature(com.modelsolv.reprezen.rapidml.PrimitiveProperty newConceptualFeature) {
		com.modelsolv.reprezen.rapidml.PrimitiveProperty oldConceptualFeature = conceptualFeature;
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RapidmlPackage.PROPERTY_REFERENCE__CONCEPTUAL_FEATURE:
				setConceptualFeature((com.modelsolv.reprezen.rapidml.PrimitiveProperty)newValue);
				return;
		}
    ...
    public void eUnset(int featureID) {
		switch (featureID) {
			case RapidmlPackage.PROPERTY_REFERENCE__CONCEPTUAL_FEATURE:
				setConceptualFeature((com.modelsolv.reprezen.rapidml.PrimitiveProperty)null);
				return;
		}
