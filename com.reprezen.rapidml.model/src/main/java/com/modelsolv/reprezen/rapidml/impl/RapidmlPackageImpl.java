...
import com.modelsolv.reprezen.rapidml.SimpleType;
...
public class RapidmlPackageImpl extends EPackageImpl implements RapidmlPackage {
	 ...
	 * @see com.modelsolv.reprezen.rapidml.RapidmlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
    ...
    public void initializePackageContents() {
		...
		initEClass(uriEClass, com.modelsolv.reprezen.rapidml.URI.class, "URI", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getURI_Segments(), this.getURISegment(), null, "segments", null, 1, -1, com.modelsolv.reprezen.rapidml.URI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getURI_UriParameters(), this.getURIParameter(), this.getURIParameter_ContainingURI(), "uriParameters", null, 0, -1, com.modelsolv.reprezen.rapidml.URI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
