 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#isWithDefaultRealization <em>With Default Realization</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getInlineObjectRealization <em>Inline Object Realization</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getReferenceTreatments <em>Reference Treatments</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getRealizationName <em>Realization Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.RealizationContainerImpl#getEffectiveRealization <em>Effective Realization</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RealizationContainerImpl extends EObjectImpl implements RealizationContainer {
	 ...
	 * @ordered
	 */
    protected com.modelsolv.reprezen.rapidml.Structure dataType;
    ...
    public EList<Extension> getExtensions() {
		if (extensions == null) {
			extensions = new EObjectContainmentEList<Extension>(Extension.class, this, RapidmlPackage.REALIZATION_CONTAINER__EXTENSIONS);
		}
		return extensions;
	}
    ...
    public void setWithDefaultRealization(boolean newWithDefaultRealization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__WITH_DEFAULT_REALIZATION, oldWithDefaultRealization, withDefaultRealization));
	}
    ...
    public NotificationChain basicSetInlineObjectRealization(ObjectRealization newInlineObjectRealization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__INLINE_OBJECT_REALIZATION, oldInlineObjectRealization, newInlineObjectRealization);
    ...
    public void setInlineObjectRealization(ObjectRealization newInlineObjectRealization) {
		if (newInlineObjectRealization != inlineObjectRealization) {
			...
			if (inlineObjectRealization != null)
				msgs = ((InternalEObject)inlineObjectRealization).eInverseRemove(this, RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER, ObjectRealization.class, msgs);
			if (newInlineObjectRealization != null)
				msgs = ((InternalEObject)newInlineObjectRealization).eInverseAdd(this, RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER, ObjectRealization.class, msgs);
			msgs = basicSetInlineObjectRealization(newInlineObjectRealization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__INLINE_OBJECT_REALIZATION, newInlineObjectRealization, newInlineObjectRealization));
	}
    ...
    public ObjectRealization getPropertiesGen() {
		if (properties != null && properties.eIsProxy()) {
			...
			if (properties != oldProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RapidmlPackage.REALIZATION_CONTAINER__PROPERTIES, oldProperties, properties));
			}
		}
		return properties;
	}
    ...
    public void setProperties(ObjectRealization newProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__PROPERTIES, oldProperties, properties));
	}
    ...
    public EList<ReferenceTreatment> getReferenceTreatmentsGen() {
		if (referenceTreatments == null) {
			referenceTreatments = new EObjectContainmentEList<ReferenceTreatment>(ReferenceTreatment.class, this, RapidmlPackage.REALIZATION_CONTAINER__REFERENCE_TREATMENTS);
		}
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.Structure getDataType() {
		if (dataType != null && dataType.eIsProxy()) {
			InternalEObject oldDataType = (InternalEObject)dataType;
			dataType = (com.modelsolv.reprezen.rapidml.Structure)eResolveProxy(oldDataType);
			if (dataType != oldDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RapidmlPackage.REALIZATION_CONTAINER__DATA_TYPE, oldDataType, dataType));
			}
		}
		return dataType;
	}
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.Structure basicGetDataType() {
		return dataType;
	}
	 ...
	 * @generated
	 */
	public void setDataType(com.modelsolv.reprezen.rapidml.Structure newDataType) {
		com.modelsolv.reprezen.rapidml.Structure oldDataType = dataType;
		dataType = newDataType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__DATA_TYPE, oldDataType, dataType));
	}
    ...
    public void setRealizationName(String newRealizationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__REALIZATION_NAME, oldRealizationName, realizationName));
	}
    ...
    public void setEffectiveRealization(EffectiveRealization newEffectiveRealization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_CONTAINER__EFFECTIVE_REALIZATION, oldEffectiveRealization, effectiveRealization));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RapidmlPackage.REALIZATION_CONTAINER__INLINE_OBJECT_REALIZATION:
				if (inlineObjectRealization != null)
					msgs = ((InternalEObject)inlineObjectRealization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RapidmlPackage.REALIZATION_CONTAINER__INLINE_OBJECT_REALIZATION, null, msgs);
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RapidmlPackage.REALIZATION_CONTAINER__REFERENCE_TREATMENTS:
				...
				return;
			case RapidmlPackage.REALIZATION_CONTAINER__DATA_TYPE:
				setDataType((com.modelsolv.reprezen.rapidml.Structure)newValue);
				return;
			case RapidmlPackage.REALIZATION_CONTAINER__REALIZATION_NAME:
    ...
    public void eUnset(int featureID) {
		switch (featureID) {
			...
			case RapidmlPackage.REALIZATION_CONTAINER__REFERENCE_TREATMENTS:
				...
				return;
			case RapidmlPackage.REALIZATION_CONTAINER__DATA_TYPE:
				setDataType((com.modelsolv.reprezen.rapidml.Structure)null);
				return;
			case RapidmlPackage.REALIZATION_CONTAINER__REALIZATION_NAME:
