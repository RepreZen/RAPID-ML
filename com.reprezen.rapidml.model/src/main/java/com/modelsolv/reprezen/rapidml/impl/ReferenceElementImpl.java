 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.ReferenceElementImpl#getDataType <em>Data Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ReferenceElementImpl extends ElementImpl implements ReferenceElement {
    ...
    protected EClass eStaticClass() {
        return RapidmlPackage.Literals.REFERENCE_ELEMENT;
    }
        ...
        if (dataType != null && dataType.eIsProxy()) {
            ...
            if (dataType != oldDataType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RapidmlPackage.REFERENCE_ELEMENT__DATA_TYPE, oldDataType, dataType));
            }
        }
        return dataType;
    }
    ...
    public void setDataType(Structure newDataType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_ELEMENT__DATA_TYPE, oldDataType, dataType));
    }
