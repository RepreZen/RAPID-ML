 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getSecuredBy <em>Secured By</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getBaseURI <em>Base URI</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getOwnedResourceDefinitions <em>Owned Resource Definitions</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getServiceDataModels <em>Service Data Models</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getFormats <em>Formats</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getDefinedMediaTypes <em>Defined Media Types</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getDefinedLinkRelations <em>Defined Link Relations</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getDefaultReferenceRealizations <em>Default Reference Realizations</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ResourceAPIImpl#getAutoRealizations <em>Auto Realizations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceAPIImpl extends RESTElementImpl implements ResourceAPI {
	 ...
	 * @ordered
	 */
    protected EList<com.modelsolv.reprezen.rapidml.DataModel> serviceDataModels;
	 ...
	 * @generated
	 */
    public EList<com.modelsolv.reprezen.rapidml.DataModel> getServiceDataModels() {
		if (serviceDataModels == null) {
			serviceDataModels = new EObjectResolvingEList<com.modelsolv.reprezen.rapidml.DataModel>(com.modelsolv.reprezen.rapidml.DataModel.class, this, RapidmlPackage.RESOURCE_API__SERVICE_DATA_MODELS);
		}
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RapidmlPackage.RESOURCE_API__SERVICE_DATA_MODELS:
				...
				getServiceDataModels().addAll((Collection<? extends com.modelsolv.reprezen.rapidml.DataModel>)newValue);
				return;
			case RapidmlPackage.RESOURCE_API__FORMATS:
				getFormats().clear();
