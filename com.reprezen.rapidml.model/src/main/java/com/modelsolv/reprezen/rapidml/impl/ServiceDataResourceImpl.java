 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getSecuredBy <em>Secured By</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getMediaTypes <em>Media Types</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getAllMediaTypes <em>All Media Types</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getURI <em>URI</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#isDefault <em>Default</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.ServiceDataResourceImpl#getDefinedLinkDescriptors <em>Defined Link Descriptors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceDataResourceImpl extends RealizationContainerImpl implements ServiceDataResource {
    ...
    public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RapidmlPackage.SERVICE_DATA_RESOURCE__DOCUMENTATION, oldDocumentation, newDocumentation);
    ...
    public void setDocumentation(Documentation newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RapidmlPackage.SERVICE_DATA_RESOURCE__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RapidmlPackage.SERVICE_DATA_RESOURCE__DOCUMENTATION, null, msgs);
			msgs = basicSetDocumentation(newDocumentation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.SERVICE_DATA_RESOURCE__DOCUMENTATION, newDocumentation, newDocumentation));
	}
    ...
    public EList<Example> getExamples() {
		if (examples == null) {
			examples = new EObjectContainmentEList<Example>(Example.class, this, RapidmlPackage.SERVICE_DATA_RESOURCE__EXAMPLES);
		}
		return examples;
	}
    ...
    public EList<AuthenticationMethod> getSecuredBy() {
		if (securedBy == null) {
			securedBy = new EObjectContainmentEList<AuthenticationMethod>(AuthenticationMethod.class, this, RapidmlPackage.SERVICE_DATA_RESOURCE__SECURED_BY);
		}
		return securedBy;
	}
    ...
    public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentWithInverseEList<Method>(Method.class, this, RapidmlPackage.SERVICE_DATA_RESOURCE__METHODS, RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION);
		}
		return methods;
	}
    ...
    public EList<MediaType> getMediaTypes() {
		if (mediaTypes == null) {
			mediaTypes = new EObjectResolvingEList<MediaType>(MediaType.class, this, RapidmlPackage.SERVICE_DATA_RESOURCE__MEDIA_TYPES);
		}
		return mediaTypes;
	}
    ...
    public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.SERVICE_DATA_RESOURCE__NAME, oldName, name));
	}
    ...
    public EList<MediaType> getAllMediaTypes() {
		if (allMediaTypes == null) {
			allMediaTypes = new EObjectResolvingEList<MediaType>(MediaType.class, this, RapidmlPackage.SERVICE_DATA_RESOURCE__ALL_MEDIA_TYPES);
		}
    ...
    public NotificationChain basicSetURI(URI newURI, NotificationChain msgs) {
		...
		uri = newURI;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RapidmlPackage.SERVICE_DATA_RESOURCE__URI, oldURI, newURI);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setURI(URI newURI) {
		if (newURI != uri) {
			NotificationChain msgs = null;
			if (uri != null)
				msgs = ((InternalEObject)uri).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RapidmlPackage.SERVICE_DATA_RESOURCE__URI, null, msgs);
			if (newURI != null)
				msgs = ((InternalEObject)newURI).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RapidmlPackage.SERVICE_DATA_RESOURCE__URI, null, msgs);
			msgs = basicSetURI(newURI, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.SERVICE_DATA_RESOURCE__URI, newURI, newURI));
	}
    ...
    public void setDefault(boolean newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.SERVICE_DATA_RESOURCE__DEFAULT, oldDefault, default_));
	}
    ...
    public EList<NamedLinkDescriptor> getDefinedLinkDescriptors() {
		if (definedLinkDescriptors == null) {
			definedLinkDescriptors = new EObjectContainmentEList<NamedLinkDescriptor>(NamedLinkDescriptor.class, this, RapidmlPackage.SERVICE_DATA_RESOURCE__DEFINED_LINK_DESCRIPTORS);
		}
    ...
    public NamedLinkDescriptor getDefaultLinkDescriptor() {
		return com.modelsolv.reprezen.rapidml.util.RapidmlModelUtils.getDefaultLinkDescriptor(this);
	}
	 ...
	 * @generated
	 */
	public boolean isIncluded(final com.modelsolv.reprezen.rapidml.Feature feature) {
		return com.modelsolv.reprezen.rapidml.util.RapidmlModelUtils.isFeatureIncluded(this, feature);
	}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Documentable.class) {
			switch (derivedFeatureID) {
				case RapidmlPackage.SERVICE_DATA_RESOURCE__DOCUMENTATION: return RapidmlPackage.DOCUMENTABLE__DOCUMENTATION;
				default: return -1;
			}
		}
		...
		if (baseClass == WithExamples.class) {
			switch (derivedFeatureID) {
				case RapidmlPackage.SERVICE_DATA_RESOURCE__EXAMPLES: return RapidmlPackage.WITH_EXAMPLES__EXAMPLES;
				default: return -1;
			}
		}
		if (baseClass == HasSecurityValue.class) {
			switch (derivedFeatureID) {
				case RapidmlPackage.SERVICE_DATA_RESOURCE__SECURED_BY: return RapidmlPackage.HAS_SECURITY_VALUE__SECURED_BY;
				default: return -1;
			}
		}
		if (baseClass == ResourceDefinition.class) {
			switch (derivedFeatureID) {
				case RapidmlPackage.SERVICE_DATA_RESOURCE__METHODS: return RapidmlPackage.RESOURCE_DEFINITION__METHODS;
				case RapidmlPackage.SERVICE_DATA_RESOURCE__MEDIA_TYPES: return RapidmlPackage.RESOURCE_DEFINITION__MEDIA_TYPES;
				case RapidmlPackage.SERVICE_DATA_RESOURCE__NAME: return RapidmlPackage.RESOURCE_DEFINITION__NAME;
				case RapidmlPackage.SERVICE_DATA_RESOURCE__ALL_MEDIA_TYPES: return RapidmlPackage.RESOURCE_DEFINITION__ALL_MEDIA_TYPES;
				case RapidmlPackage.SERVICE_DATA_RESOURCE__URI: return RapidmlPackage.RESOURCE_DEFINITION__URI;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Documentable.class) {
			switch (baseFeatureID) {
				case RapidmlPackage.DOCUMENTABLE__DOCUMENTATION: return RapidmlPackage.SERVICE_DATA_RESOURCE__DOCUMENTATION;
				default: return -1;
			}
		}
		if (baseClass == RESTElement.class) {
		...
		if (baseClass == WithExamples.class) {
			switch (baseFeatureID) {
				case RapidmlPackage.WITH_EXAMPLES__EXAMPLES: return RapidmlPackage.SERVICE_DATA_RESOURCE__EXAMPLES;
				default: return -1;
			}
		}
		if (baseClass == HasSecurityValue.class) {
			switch (baseFeatureID) {
				case RapidmlPackage.HAS_SECURITY_VALUE__SECURED_BY: return RapidmlPackage.SERVICE_DATA_RESOURCE__SECURED_BY;
				default: return -1;
			}
		}
		if (baseClass == ResourceDefinition.class) {
			switch (baseFeatureID) {
				case RapidmlPackage.RESOURCE_DEFINITION__METHODS: return RapidmlPackage.SERVICE_DATA_RESOURCE__METHODS;
				case RapidmlPackage.RESOURCE_DEFINITION__MEDIA_TYPES: return RapidmlPackage.SERVICE_DATA_RESOURCE__MEDIA_TYPES;
				case RapidmlPackage.RESOURCE_DEFINITION__NAME: return RapidmlPackage.SERVICE_DATA_RESOURCE__NAME;
				case RapidmlPackage.RESOURCE_DEFINITION__ALL_MEDIA_TYPES: return RapidmlPackage.SERVICE_DATA_RESOURCE__ALL_MEDIA_TYPES;
				case RapidmlPackage.RESOURCE_DEFINITION__URI: return RapidmlPackage.SERVICE_DATA_RESOURCE__URI;
				default: return -1;
			}
		}
