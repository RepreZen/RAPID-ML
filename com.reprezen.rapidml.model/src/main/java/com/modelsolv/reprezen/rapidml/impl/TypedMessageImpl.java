 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.TypedMessageImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.TypedMessageImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.TypedMessageImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.TypedMessageImpl#getResourceType <em>Resource Type</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.TypedMessageImpl#isUseParentTypeReference <em>Use Parent Type Reference</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.TypedMessageImpl#getMediaTypes <em>Media Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypedMessageImpl extends RealizationContainerImpl implements TypedMessage {
    ...
    public EList<Example> getAllExamples() {
		return com.modelsolv.reprezen.rapidml.util.ExampleUtils.getAllExamples(this);
	}
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.rapidml.Structure getActualType() {
