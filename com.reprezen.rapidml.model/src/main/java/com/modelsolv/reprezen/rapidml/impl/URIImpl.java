 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.URIImpl#getSegments <em>Segments</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.impl.URIImpl#getUriParameters <em>Uri Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class URIImpl extends EObjectImpl implements URI {
    ...
    public EList<URIParameter> getUriParameters() {
		if (uriParameters == null) {
			uriParameters = new EObjectContainmentWithInverseEList<URIParameter>(URIParameter.class, this, RapidmlPackage.URI__URI_PARAMETERS, RapidmlPackage.URI_PARAMETER__CONTAINING_URI);
		}
