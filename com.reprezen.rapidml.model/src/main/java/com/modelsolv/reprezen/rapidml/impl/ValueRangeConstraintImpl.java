 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.ValueRangeConstraintImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.ValueRangeConstraintImpl#isMinValueExclusive <em>Min Value Exclusive</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.ValueRangeConstraintImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.rapidml.datatypes.impl.ValueRangeConstraintImpl#isMaxValueExclusive <em>Max Value Exclusive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueRangeConstraintImpl extends ConstraintImpl implements ValueRangeConstraint {
    ...
    public void setMinValue(String newMinValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.VALUE_RANGE_CONSTRAINT__MIN_VALUE, oldMinValue, minValue));
    }
    ...
    public void setMinValueExclusive(boolean newMinValueExclusive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.VALUE_RANGE_CONSTRAINT__MIN_VALUE_EXCLUSIVE, oldMinValueExclusive, minValueExclusive));
    }
    ...
    public void setMaxValue(String newMaxValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.VALUE_RANGE_CONSTRAINT__MAX_VALUE, oldMaxValue, maxValue));
    }
    ...
    public void setMaxValueExclusive(boolean newMaxValueExclusive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.VALUE_RANGE_CONSTRAINT__MAX_VALUE_EXCLUSIVE, oldMaxValueExclusive, maxValueExclusive));
    }
