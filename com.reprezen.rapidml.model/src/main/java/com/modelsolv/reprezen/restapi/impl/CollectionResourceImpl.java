 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.CollectionResourceImpl#getCollectionParameters <em>Collection Parameters</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.CollectionResourceImpl#getReferenceElements <em>Reference Elements</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.CollectionResourceImpl#getResourceRealizationKind <em>Resource Realization Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionResourceImpl extends ServiceDataResourceImpl implements CollectionResource {
    /**
	 * The cached value of the '{@link #getCollectionParameters() <em>Collection Parameters</em>}' containment reference list.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
	 * The cached value of the '{@link #getReferenceElements() <em>Reference Elements</em>}' containment reference list.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
	 * The default value of the '{@link #getResourceRealizationKind() <em>Resource Realization Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
	 * The cached value of the '{@link #getResourceRealizationKind() <em>Resource Realization Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see #getResourceRealizationKind()
	 * @generated
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.COLLECTION_RESOURCE;
	}
    ...
    public EList<CollectionParameter> getCollectionParameters() {
		if (collectionParameters == null) {
			collectionParameters = new EObjectContainmentWithInverseEList<CollectionParameter>(CollectionParameter.class, this, RestapiPackage.COLLECTION_RESOURCE__COLLECTION_PARAMETERS, RestapiPackage.COLLECTION_PARAMETER__CONTAINING_RESOURCE_DEFINITION);
		}
    ...
    public EList<CollectionReferenceElement> getReferenceElements() {
		if (referenceElements == null) {
			referenceElements = new EObjectContainmentEList<CollectionReferenceElement>(CollectionReferenceElement.class, this, RestapiPackage.COLLECTION_RESOURCE__REFERENCE_ELEMENTS);
		}
    ...
    public void setResourceRealizationKind(CollectionRealizationEnum newResourceRealizationKind) {
		...
		resourceRealizationKind = newResourceRealizationKind == null ? RESOURCE_REALIZATION_KIND_EDEFAULT : newResourceRealizationKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.COLLECTION_RESOURCE__RESOURCE_REALIZATION_KIND, oldResourceRealizationKind, resourceRealizationKind));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.COLLECTION_RESOURCE__COLLECTION_PARAMETERS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getCollectionParameters()).basicAdd(otherEnd, msgs);
		}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RestapiPackage.COLLECTION_RESOURCE__REFERENCE_ELEMENTS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RestapiPackage.COLLECTION_RESOURCE__RESOURCE_REALIZATION_KIND:
