 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.ConstraintImpl#getExtensions <em>Extensions</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConstraintImpl extends EObjectImpl implements Constraint {
    ...
    protected EClass eStaticClass() {
        return RestapiPackage.Literals.CONSTRAINT;
    }
    ...
    public EList<Extension> getExtensions() {
        if (extensions == null) {
            extensions = new EObjectContainmentEList<Extension>(Extension.class, this, RestapiPackage.CONSTRAINT__EXTENSIONS);
        }
        return extensions;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RestapiPackage.CONSTRAINT__EXTENSIONS:
