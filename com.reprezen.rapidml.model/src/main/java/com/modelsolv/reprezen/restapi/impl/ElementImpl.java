 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.ElementImpl#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementImpl extends EObjectImpl implements Element {
    ...
    protected EClass eStaticClass() {
        return RestapiPackage.Literals.ELEMENT;
    }
    ...
    public void setCardinality(int[] newCardinality) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.ELEMENT__CARDINALITY, oldCardinality, cardinality));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RestapiPackage.ELEMENT__CARDINALITY:
