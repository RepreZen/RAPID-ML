 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.EnumConstantImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.EnumConstantImpl#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.EnumConstantImpl#getLiteralValue <em>Literal Value</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.EnumConstantImpl#getEnumeration <em>Enumeration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumConstantImpl extends DocumentableImpl implements EnumConstant {
    ...
    protected EClass eStaticClass() {
        return RestapiPackage.Literals.ENUM_CONSTANT;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.ENUM_CONSTANT__NAME, oldName, name));
    }
    ...
    public void setIntegerValue(int newIntegerValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.ENUM_CONSTANT__INTEGER_VALUE, oldIntegerValue, integerValue, !oldIntegerValueESet));
    }
    ...
    public void unsetIntegerValue() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RestapiPackage.ENUM_CONSTANT__INTEGER_VALUE, oldIntegerValue, INTEGER_VALUE_EDEFAULT, oldIntegerValueESet));
    }
    ...
    public void setLiteralValue(String newLiteralValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.ENUM_CONSTANT__LITERAL_VALUE, oldLiteralValue, literalValue));
    }
    ...
    public Enumeration getEnumeration() {
        if (eContainerFeatureID() != RestapiPackage.ENUM_CONSTANT__ENUMERATION) return null;
    ...
    public NotificationChain basicSetEnumeration(Enumeration newEnumeration, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newEnumeration, RestapiPackage.ENUM_CONSTANT__ENUMERATION, msgs);
        return msgs;
    }
    ...
    public void setEnumeration(Enumeration newEnumeration) {
        if (newEnumeration != eInternalContainer() || (eContainerFeatureID() != RestapiPackage.ENUM_CONSTANT__ENUMERATION && newEnumeration != null)) {
            ...
            if (newEnumeration != null)
                msgs = ((InternalEObject)newEnumeration).eInverseAdd(this, RestapiPackage.ENUMERATION__ENUM_CONSTANTS, Enumeration.class, msgs);
            msgs = basicSetEnumeration(newEnumeration, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.ENUM_CONSTANT__ENUMERATION, newEnumeration, newEnumeration));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RestapiPackage.ENUM_CONSTANT__ENUMERATION:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case RestapiPackage.ENUM_CONSTANT__ENUMERATION:
                return eInternalContainer().eInverseRemove(this, RestapiPackage.ENUMERATION__ENUM_CONSTANTS, Enumeration.class, msgs);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RestapiPackage.ENUM_CONSTANT__NAME:
                return getName();
            case RestapiPackage.ENUM_CONSTANT__INTEGER_VALUE:
                return getIntegerValue();
            case RestapiPackage.ENUM_CONSTANT__LITERAL_VALUE:
