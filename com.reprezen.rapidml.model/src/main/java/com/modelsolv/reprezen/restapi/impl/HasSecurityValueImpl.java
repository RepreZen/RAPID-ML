 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.HasSecurityValueImpl#getSecuredBy <em>Secured By</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class HasSecurityValueImpl extends EObjectImpl implements HasSecurityValue {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.HAS_SECURITY_VALUE;
	}
    ...
    public EList<AuthenticationMethod> getSecuredBy() {
		if (securedBy == null) {
			securedBy = new EObjectContainmentEList<AuthenticationMethod>(AuthenticationMethod.class, this, RestapiPackage.HAS_SECURITY_VALUE__SECURED_BY);
		}
		return securedBy;
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.HAS_SECURITY_VALUE__SECURED_BY:
