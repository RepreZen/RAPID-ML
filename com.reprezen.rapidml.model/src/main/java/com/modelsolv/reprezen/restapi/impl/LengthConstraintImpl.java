 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.LengthConstraintImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.LengthConstraintImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.LengthConstraintImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LengthConstraintImpl extends ConstraintImpl implements LengthConstraint {
    ...
    protected EClass eStaticClass() {
        return RestapiPackage.Literals.LENGTH_CONSTRAINT;
    }
    ...
    public void setMinLength(int newMinLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.LENGTH_CONSTRAINT__MIN_LENGTH, oldMinLength, minLength, !oldMinLengthESet));
    }
    ...
    public void unsetMinLength() {
        ...
        minLengthESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RestapiPackage.LENGTH_CONSTRAINT__MIN_LENGTH, oldMinLength, MIN_LENGTH_EDEFAULT, oldMinLengthESet));
    }
    ...
    public void setMaxLength(int newMaxLength) {
        ...
        maxLengthESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.LENGTH_CONSTRAINT__MAX_LENGTH, oldMaxLength, maxLength, !oldMaxLengthESet));
    }
    ...
    public void unsetMaxLength() {
        ...
        maxLengthESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, RestapiPackage.LENGTH_CONSTRAINT__MAX_LENGTH, oldMaxLength, MAX_LENGTH_EDEFAULT, oldMaxLengthESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RestapiPackage.LENGTH_CONSTRAINT__MIN_LENGTH:
                return getMinLength();
            case RestapiPackage.LENGTH_CONSTRAINT__MAX_LENGTH:
                return getMaxLength();
            case RestapiPackage.LENGTH_CONSTRAINT__LENGTH:
                return getLength();
        }
