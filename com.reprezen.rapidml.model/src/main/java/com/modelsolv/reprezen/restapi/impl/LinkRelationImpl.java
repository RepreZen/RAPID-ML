 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.LinkRelationImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.LinkRelationImpl#getSpecURL <em>Spec URL</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkRelationImpl extends DocumentableImpl implements LinkRelation {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.LINK_RELATION;
	}
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.LINK_RELATION__NAME, oldName, name));
	}
    ...
    public void setSpecURL(String newSpecURL) {
		...
		specURL = newSpecURL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.LINK_RELATION__SPEC_URL, oldSpecURL, specURL));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestapiPackage.LINK_RELATION__NAME:
				return getName();
			case RestapiPackage.LINK_RELATION__SPEC_URL:
				return getSpecURL();
		}
