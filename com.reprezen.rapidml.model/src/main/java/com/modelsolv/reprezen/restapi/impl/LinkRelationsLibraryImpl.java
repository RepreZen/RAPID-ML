 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.LinkRelationsLibraryImpl#getDefinedLinkRelations <em>Defined Link Relations</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.LinkRelationsLibraryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkRelationsLibraryImpl extends EObjectImpl implements LinkRelationsLibrary {
	...
	protected EClass eStaticClass() {
		return RestapiPackage.Literals.LINK_RELATIONS_LIBRARY;
	}
	...
	public EList<LinkRelation> getDefinedLinkRelations() {
		if (definedLinkRelations == null) {
			definedLinkRelations = new EObjectContainmentEList<LinkRelation>(LinkRelation.class, this, RestapiPackage.LINK_RELATIONS_LIBRARY__DEFINED_LINK_RELATIONS);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.LINK_RELATIONS_LIBRARY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.LINK_RELATIONS_LIBRARY__DEFINED_LINK_RELATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RestapiPackage.LINK_RELATIONS_LIBRARY__NAME:
				return getName();
		}
