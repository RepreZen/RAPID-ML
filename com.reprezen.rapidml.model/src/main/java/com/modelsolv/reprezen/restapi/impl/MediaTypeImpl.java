 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MediaTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MediaTypeImpl#getSpecURL <em>Spec URL</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MediaTypeImpl#getDerivedFrom <em>Derived From</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MediaTypeImpl extends RESTElementImpl implements MediaType {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.MEDIA_TYPE;
	}
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.MEDIA_TYPE__NAME, oldName, name));
	}
    ...
    public void setSpecURL(String newSpecURL) {
		...
		specURL = newSpecURL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.MEDIA_TYPE__SPEC_URL, oldSpecURL, specURL));
	}
    ...
    public EList<MediaType> getDerivedFrom() {
		if (derivedFrom == null) {
			derivedFrom = new EObjectResolvingEList<MediaType>(MediaType.class, this, RestapiPackage.MEDIA_TYPE__DERIVED_FROM);
		}
		return derivedFrom;
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestapiPackage.MEDIA_TYPE__NAME:
				return getName();
			case RestapiPackage.MEDIA_TYPE__SPEC_URL:
				return getSpecURL();
			case RestapiPackage.MEDIA_TYPE__DERIVED_FROM:
