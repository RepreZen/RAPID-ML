...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Media Types Library</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MediaTypesLibraryImpl#getMediaTypes <em>Media Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MediaTypesLibraryImpl extends EObjectImpl implements MediaTypesLibrary {
	...
	protected EClass eStaticClass() {
		return RestapiPackage.Literals.MEDIA_TYPES_LIBRARY;
	}
	...
	public EList<MediaType> getMediaTypes() {
		if (mediaTypes == null) {
			mediaTypes = new EObjectContainmentEList.Unsettable<MediaType>(MediaType.class, this, RestapiPackage.MEDIA_TYPES_LIBRARY__MEDIA_TYPES);
		}
		return mediaTypes;
	}
	...
	public void unsetMediaTypes() {
		if (mediaTypes != null) ((InternalEList.Unsettable<?>)mediaTypes).unset();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.MEDIA_TYPES_LIBRARY__MEDIA_TYPES:
