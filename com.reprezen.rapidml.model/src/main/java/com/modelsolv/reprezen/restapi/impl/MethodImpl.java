 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MethodImpl#getSecuredBy <em>Secured By</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MethodImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MethodImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MethodImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MethodImpl#getHttpMethod <em>Http Method</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.MethodImpl#getContainingResourceDefinition <em>Containing Resource Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodImpl extends RESTElementImpl implements Method {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.METHOD;
	}
    ...
    public EList<AuthenticationMethod> getSecuredBy() {
		if (securedBy == null) {
			securedBy = new EObjectContainmentEList<AuthenticationMethod>(AuthenticationMethod.class, this, RestapiPackage.METHOD__SECURED_BY);
		}
		return securedBy;
	}
    ...
    public NotificationChain basicSetRequest(TypedRequest newRequest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RestapiPackage.METHOD__REQUEST, oldRequest, newRequest);
    ...
    public void setRequest(TypedRequest newRequest) {
		if (newRequest != request) {
			...
			if (request != null)
				msgs = ((InternalEObject)request).eInverseRemove(this, RestapiPackage.TYPED_REQUEST__CONTAINING_METHOD, TypedRequest.class, msgs);
			if (newRequest != null)
				msgs = ((InternalEObject)newRequest).eInverseAdd(this, RestapiPackage.TYPED_REQUEST__CONTAINING_METHOD, TypedRequest.class, msgs);
			msgs = basicSetRequest(newRequest, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.METHOD__REQUEST, newRequest, newRequest));
	}
    ...
    public EList<TypedResponse> getResponses() {
		if (responses == null) {
			responses = new EObjectContainmentWithInverseEList<TypedResponse>(TypedResponse.class, this, RestapiPackage.METHOD__RESPONSES, RestapiPackage.TYPED_RESPONSE__CONTAINING_METHOD);
		}
		return responses;
	}
    ...
    public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.METHOD__ID, oldId, id));
	}
    ...
    public void setHttpMethod(HTTPMethods newHttpMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.METHOD__HTTP_METHOD, oldHttpMethod, httpMethod));
	}
    ...
    public ResourceDefinition getContainingResourceDefinition() {
		if (eContainerFeatureID() != RestapiPackage.METHOD__CONTAINING_RESOURCE_DEFINITION) return null;
    ...
    public NotificationChain basicSetContainingResourceDefinition(ResourceDefinition newContainingResourceDefinition, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainingResourceDefinition, RestapiPackage.METHOD__CONTAINING_RESOURCE_DEFINITION, msgs);
		return msgs;
	}
    ...
    public void setContainingResourceDefinition(ResourceDefinition newContainingResourceDefinition) {
		if (newContainingResourceDefinition != eInternalContainer() || (eContainerFeatureID() != RestapiPackage.METHOD__CONTAINING_RESOURCE_DEFINITION && newContainingResourceDefinition != null)) {
			...
			if (newContainingResourceDefinition != null)
				msgs = ((InternalEObject)newContainingResourceDefinition).eInverseAdd(this, RestapiPackage.RESOURCE_DEFINITION__METHODS, ResourceDefinition.class, msgs);
			msgs = basicSetContainingResourceDefinition(newContainingResourceDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.METHOD__CONTAINING_RESOURCE_DEFINITION, newContainingResourceDefinition, newContainingResourceDefinition));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.METHOD__REQUEST:
				if (request != null)
					msgs = ((InternalEObject)request).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RestapiPackage.METHOD__REQUEST, null, msgs);
				return basicSetRequest((TypedRequest)otherEnd, msgs);
			case RestapiPackage.METHOD__RESPONSES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getResponses()).basicAdd(otherEnd, msgs);
			case RestapiPackage.METHOD__CONTAINING_RESOURCE_DEFINITION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.METHOD__SECURED_BY:
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RestapiPackage.METHOD__CONTAINING_RESOURCE_DEFINITION:
				return eInternalContainer().eInverseRemove(this, RestapiPackage.RESOURCE_DEFINITION__METHODS, ResourceDefinition.class, msgs);
		}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RestapiPackage.METHOD__RESPONSES:
				return getResponses();
			case RestapiPackage.METHOD__ID:
				return getId();
			case RestapiPackage.METHOD__HTTP_METHOD:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == HasSecurityValue.class) {
			switch (derivedFeatureID) {
				case RestapiPackage.METHOD__SECURED_BY: return RestapiPackage.HAS_SECURITY_VALUE__SECURED_BY;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HasSecurityValue.class) {
			switch (baseFeatureID) {
				case RestapiPackage.HAS_SECURITY_VALUE__SECURED_BY: return RestapiPackage.METHOD__SECURED_BY;
				default: return -1;
			}
		}
