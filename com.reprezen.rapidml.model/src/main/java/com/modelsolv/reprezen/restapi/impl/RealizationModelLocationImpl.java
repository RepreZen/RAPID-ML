 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.RealizationModelLocationImpl#getUri <em>Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealizationModelLocationImpl extends EObjectImpl implements RealizationModelLocation {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.REALIZATION_MODEL_LOCATION;
	}
    ...
    public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REALIZATION_MODEL_LOCATION__URI, oldUri, uri));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestapiPackage.REALIZATION_MODEL_LOCATION__URI:
				return getUri();
		}
