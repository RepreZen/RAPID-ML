 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceLinkImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceLinkImpl#getLinkRelation <em>Link Relation</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceLinkImpl#getCollectionRealizationLevel <em>Collection Realization Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceLinkImpl extends ReferenceTreatmentImpl implements ReferenceLink {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.REFERENCE_LINK;
	}
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_LINK__NAME, oldName, name));
	}
    ...
    public LinkRelation getLinkRelation() {
		if (linkRelation != null && linkRelation.eIsProxy()) {
			...
			if (linkRelation != oldLinkRelation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestapiPackage.REFERENCE_LINK__LINK_RELATION, oldLinkRelation, linkRelation));
			}
		}
		return linkRelation;
	}
    ...
    public void setLinkRelation(LinkRelation newLinkRelation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_LINK__LINK_RELATION, oldLinkRelation, linkRelation));
	}
    ...
    public CollectionRealizationLevelEnum getCollectionRealizationLevel() {
        if (!eIsSet(RestapiPackage.REFERENCE_LINK__COLLECTION_REALIZATION_LEVEL)) {
    ...
    public void setCollectionRealizationLevel(CollectionRealizationLevelEnum newCollectionRealizationLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_LINK__COLLECTION_REALIZATION_LEVEL, oldCollectionRealizationLevel, collectionRealizationLevel));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestapiPackage.REFERENCE_LINK__NAME:
				return getName();
			case RestapiPackage.REFERENCE_LINK__LINK_RELATION:
				if (resolve) return getLinkRelation();
				return basicGetLinkRelation();
			case RestapiPackage.REFERENCE_LINK__COLLECTION_REALIZATION_LEVEL:
