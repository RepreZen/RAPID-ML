 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceRealizationImpl#getTargetResource <em>Target Resource</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceRealizationImpl#getRealizationType <em>Realization Type</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceRealizationImpl#isMultiValued <em>Multi Valued</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceRealizationImpl extends RealizationContainerImpl implements ReferenceRealization {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.REFERENCE_REALIZATION;
	}
		...
		if (targetResource != null && targetResource.eIsProxy()) {
			...
			if (targetResource != oldTargetResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestapiPackage.REFERENCE_REALIZATION__TARGET_RESOURCE, oldTargetResource, targetResource));
			}
		}
    ...
    public void setTargetResource(ResourceDefinition newTargetResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_REALIZATION__TARGET_RESOURCE, oldTargetResource, targetResource));
	}
    ...
    public void setRealizationType(ReferenceRealizationEnum newRealizationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_REALIZATION__REALIZATION_TYPE, oldRealizationType, realizationType));
	}
    ...
    public void setMultiValued(boolean newMultiValued) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_REALIZATION__MULTI_VALUED, oldMultiValued, multiValued));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestapiPackage.REFERENCE_REALIZATION__TARGET_RESOURCE:
				if (resolve) return getTargetResource();
				return basicGetTargetResource();
			case RestapiPackage.REFERENCE_REALIZATION__REALIZATION_TYPE:
				return getRealizationType();
			case RestapiPackage.REFERENCE_REALIZATION__MULTI_VALUED:
