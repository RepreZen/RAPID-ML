 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceTreatmentImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceTreatmentImpl#getReferenceElement <em>Reference Element</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceTreatmentImpl#getReferenceRealization <em>Reference Realization</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.ReferenceTreatmentImpl#getOwnedReferenceRealization <em>Owned Reference Realization</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceTreatmentImpl extends EObjectImpl implements ReferenceTreatment {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.REFERENCE_TREATMENT;
	}
    ...
    public EList<Extension> getExtensions() {
		if (extensions == null) {
			extensions = new EObjectContainmentEList<Extension>(Extension.class, this, RestapiPackage.REFERENCE_TREATMENT__EXTENSIONS);
		}
		return extensions;
	}
		...
		if (referenceElement != null && referenceElement.eIsProxy()) {
			...
			if (referenceElement != oldReferenceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestapiPackage.REFERENCE_TREATMENT__REFERENCE_ELEMENT, oldReferenceElement, referenceElement));
			}
		}
	...
	public void setReferenceElement(com.modelsolv.reprezen.restapi.ReferenceElement newReferenceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_TREATMENT__REFERENCE_ELEMENT, oldReferenceElement, referenceElement));
	}
    ...
    public ReferenceRealization getReferenceRealizationGen() {
		if (referenceRealization != null && referenceRealization.eIsProxy()) {
			...
			if (referenceRealization != oldReferenceRealization) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestapiPackage.REFERENCE_TREATMENT__REFERENCE_REALIZATION, oldReferenceRealization, referenceRealization));
			}
		}
    ...
    public void setReferenceRealization(ReferenceRealization newReferenceRealization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_TREATMENT__REFERENCE_REALIZATION, oldReferenceRealization, referenceRealization));
	}
    ...
    public NotificationChain basicSetOwnedReferenceRealization(ReferenceRealization newOwnedReferenceRealization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, oldOwnedReferenceRealization, newOwnedReferenceRealization);
    ...
    public void setOwnedReferenceRealization(ReferenceRealization newOwnedReferenceRealization) {
		if (newOwnedReferenceRealization != ownedReferenceRealization) {
			...
			if (ownedReferenceRealization != null)
				msgs = ((InternalEObject)ownedReferenceRealization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RestapiPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, null, msgs);
			if (newOwnedReferenceRealization != null)
				msgs = ((InternalEObject)newOwnedReferenceRealization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RestapiPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, null, msgs);
			msgs = basicSetOwnedReferenceRealization(newOwnedReferenceRealization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, newOwnedReferenceRealization, newOwnedReferenceRealization));
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.REFERENCE_TREATMENT__EXTENSIONS:
				return ((InternalEList<?>)getExtensions()).basicRemove(otherEnd, msgs);
			case RestapiPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RestapiPackage.REFERENCE_TREATMENT__REFERENCE_ELEMENT:
				if (resolve) return getReferenceElement();
				return basicGetReferenceElement();
			case RestapiPackage.REFERENCE_TREATMENT__REFERENCE_REALIZATION:
