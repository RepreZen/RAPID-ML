 ...
 * @generated
 */
public class RestapiPackageImpl extends EPackageImpl implements RestapiPackage {
    /**
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.modelsolv.reprezen.restapi.RestapiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
    private RestapiPackageImpl() {
		super(eNS_URI, RestapiFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link RestapiPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
    public static RestapiPackage init() {
		if (isInited) return (RestapiPackage)EPackage.Registry.INSTANCE.getEPackage(RestapiPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredRestapiPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		RestapiPackageImpl theRestapiPackage = registeredRestapiPackage instanceof RestapiPackageImpl ? (RestapiPackageImpl)registeredRestapiPackage : new RestapiPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theRestapiPackage.createPackageContents();

		// Initialize created meta-data
		theRestapiPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRestapiPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RestapiPackage.eNS_URI, theRestapiPackage);
		return theRestapiPackage;
	}
    ...
    public RestapiFactory getRestapiFactory() {
		return (RestapiFactory)getEFactoryInstance();
	}
    ...
    public void initializePackageContents() {
		...
		initEClass(uriEClass, com.modelsolv.reprezen.restapi.URI.class, "URI", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getURI_Segments(), this.getURISegment(), null, "segments", null, 1, -1, com.modelsolv.reprezen.restapi.URI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getURI_UriParameters(), this.getURIParameter(), this.getURIParameter_ContainingURI(), "uriParameters", null, 0, -1, com.modelsolv.reprezen.restapi.URI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
