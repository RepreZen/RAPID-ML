 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.SecuritySchemeLibraryImpl#getSecuritySchemes <em>Security Schemes</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.SecuritySchemeLibraryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecuritySchemeLibraryImpl extends DocumentableImpl implements SecuritySchemeLibrary {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.SECURITY_SCHEME_LIBRARY;
	}
    ...
    public EList<SecurityScheme> getSecuritySchemes() {
		if (securitySchemes == null) {
			securitySchemes = new EObjectContainmentEList<SecurityScheme>(SecurityScheme.class, this, RestapiPackage.SECURITY_SCHEME_LIBRARY__SECURITY_SCHEMES);
		}
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.SECURITY_SCHEME_LIBRARY__NAME, oldName, name));
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.SECURITY_SCHEME_LIBRARY__SECURITY_SCHEMES:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RestapiPackage.SECURITY_SCHEME_LIBRARY__NAME:
				return getName();
		}
