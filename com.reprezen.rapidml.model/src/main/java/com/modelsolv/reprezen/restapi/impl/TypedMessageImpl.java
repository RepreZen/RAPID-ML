 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.TypedMessageImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.TypedMessageImpl#getExamples <em>Examples</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.TypedMessageImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.TypedMessageImpl#getResourceType <em>Resource Type</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.TypedMessageImpl#isUseParentTypeReference <em>Use Parent Type Reference</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.TypedMessageImpl#getMediaTypes <em>Media Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypedMessageImpl extends RealizationContainerImpl implements TypedMessage {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.TYPED_MESSAGE;
	}
    ...
    public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RestapiPackage.TYPED_MESSAGE__DOCUMENTATION, oldDocumentation, newDocumentation);
    ...
    public void setDocumentation(Documentation newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RestapiPackage.TYPED_MESSAGE__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RestapiPackage.TYPED_MESSAGE__DOCUMENTATION, null, msgs);
			msgs = basicSetDocumentation(newDocumentation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.TYPED_MESSAGE__DOCUMENTATION, newDocumentation, newDocumentation));
	}
    ...
    public EList<Example> getExamples() {
		if (examples == null) {
			examples = new EObjectContainmentEList<Example>(Example.class, this, RestapiPackage.TYPED_MESSAGE__EXAMPLES);
		}
		return examples;
	}
    ...
    public EList<MessageParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<MessageParameter>(MessageParameter.class, this, RestapiPackage.TYPED_MESSAGE__PARAMETERS, RestapiPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE);
		}
		return parameters;
	}
    ...
    public ResourceDefinition getResourceTypeGen() {
		if (resourceType != null && resourceType.eIsProxy()) {
			...
			if (resourceType != oldResourceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestapiPackage.TYPED_MESSAGE__RESOURCE_TYPE, oldResourceType, resourceType));
			}
		}
		return resourceType;
	}
    ...
    public void setResourceType(ResourceDefinition newResourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.TYPED_MESSAGE__RESOURCE_TYPE, oldResourceType, resourceType));
	}
    ...
    public void setUseParentTypeReference(boolean newUseParentTypeReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.TYPED_MESSAGE__USE_PARENT_TYPE_REFERENCE, oldUseParentTypeReference, useParentTypeReference));
	}
    ...
    public EList<MediaType> getMediaTypes() {
		if (mediaTypes == null) {
			mediaTypes = new EObjectResolvingEList<MediaType>(MediaType.class, this, RestapiPackage.TYPED_MESSAGE__MEDIA_TYPES);
		}
		return mediaTypes;
	}
    ...
    public EList<Example> getAllExamples() {
		return com.modelsolv.reprezen.restapi.util.ExampleUtils.getAllExamples(this);
	}
	 ...
	 * @generated
	 */
    public com.modelsolv.reprezen.restapi.Structure getActualType() {
		Structure structure = getDataType();
		if (structure == null && getResourceType() instanceof com.modelsolv.reprezen.restapi.ServiceDataResource) {
		    structure = ((com.modelsolv.reprezen.restapi.ServiceDataResource) getResourceType()).getDataType();
		}
		return structure;
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.TYPED_MESSAGE__PARAMETERS:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestapiPackage.TYPED_MESSAGE__DOCUMENTATION:
				return basicSetDocumentation(null, msgs);
			case RestapiPackage.TYPED_MESSAGE__EXAMPLES:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RestapiPackage.TYPED_MESSAGE__RESOURCE_TYPE:
				if (resolve) return getResourceType();
				return basicGetResourceType();
			case RestapiPackage.TYPED_MESSAGE__USE_PARENT_TYPE_REFERENCE:
				return isUseParentTypeReference();
			case RestapiPackage.TYPED_MESSAGE__MEDIA_TYPES:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Documentable.class) {
			switch (derivedFeatureID) {
				case RestapiPackage.TYPED_MESSAGE__DOCUMENTATION: return RestapiPackage.DOCUMENTABLE__DOCUMENTATION;
				default: return -1;
			}
		}
		...
		if (baseClass == WithExamples.class) {
			switch (derivedFeatureID) {
				case RestapiPackage.TYPED_MESSAGE__EXAMPLES: return RestapiPackage.WITH_EXAMPLES__EXAMPLES;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Documentable.class) {
			switch (baseFeatureID) {
				case RestapiPackage.DOCUMENTABLE__DOCUMENTATION: return RestapiPackage.TYPED_MESSAGE__DOCUMENTATION;
				default: return -1;
			}
		}
		if (baseClass == RESTElement.class) {
		...
		if (baseClass == WithExamples.class) {
			switch (baseFeatureID) {
				case RestapiPackage.WITH_EXAMPLES__EXAMPLES: return RestapiPackage.TYPED_MESSAGE__EXAMPLES;
				default: return -1;
			}
		}
