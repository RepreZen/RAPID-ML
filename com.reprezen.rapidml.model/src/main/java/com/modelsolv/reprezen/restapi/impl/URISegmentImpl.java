 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.impl.URISegmentImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class URISegmentImpl extends EObjectImpl implements URISegment {
    ...
    protected EClass eStaticClass() {
		return RestapiPackage.Literals.URI_SEGMENT;
	}
    ...
    public String getName() {
        return RestapiModelUtils.trimQuotes(name);
    }
    ...
    public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.URI_SEGMENT__NAME, oldName, name));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestapiPackage.URI_SEGMENT__NAME:
				return getName();
		}
