 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.ValueRangeConstraintImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.ValueRangeConstraintImpl#isMinValueExclusive <em>Min Value Exclusive</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.ValueRangeConstraintImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.ValueRangeConstraintImpl#isMaxValueExclusive <em>Max Value Exclusive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueRangeConstraintImpl extends ConstraintImpl implements ValueRangeConstraint {
    ...
    /**
     * The default value of the '{@link #isMinValueExclusive() <em>Min Value Exclusive</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * The cached value of the '{@link #isMinValueExclusive() <em>Min Value Exclusive</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isMinValueExclusive()
     * @generated
    ...
    /**
     * The default value of the '{@link #isMaxValueExclusive() <em>Max Value Exclusive</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * The cached value of the '{@link #isMaxValueExclusive() <em>Max Value Exclusive</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isMaxValueExclusive()
     * @generated
    ...
    protected EClass eStaticClass() {
        return RestapiPackage.Literals.VALUE_RANGE_CONSTRAINT;
    }
    ...
    public void setMinValue(String newMinValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.VALUE_RANGE_CONSTRAINT__MIN_VALUE, oldMinValue, minValue));
    }
    ...
    public void setMinValueExclusive(boolean newMinValueExclusive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.VALUE_RANGE_CONSTRAINT__MIN_VALUE_EXCLUSIVE, oldMinValueExclusive, minValueExclusive));
    }
    ...
    public void setMaxValue(String newMaxValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.VALUE_RANGE_CONSTRAINT__MAX_VALUE, oldMaxValue, maxValue));
    }
    ...
    public void setMaxValueExclusive(boolean newMaxValueExclusive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RestapiPackage.VALUE_RANGE_CONSTRAINT__MAX_VALUE_EXCLUSIVE, oldMaxValueExclusive, maxValueExclusive));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case RestapiPackage.VALUE_RANGE_CONSTRAINT__MIN_VALUE:
                return getMinValue();
            case RestapiPackage.VALUE_RANGE_CONSTRAINT__MIN_VALUE_EXCLUSIVE:
                return isMinValueExclusive();
            case RestapiPackage.VALUE_RANGE_CONSTRAINT__MAX_VALUE:
                return getMaxValue();
            case RestapiPackage.VALUE_RANGE_CONSTRAINT__MAX_VALUE_EXCLUSIVE:
