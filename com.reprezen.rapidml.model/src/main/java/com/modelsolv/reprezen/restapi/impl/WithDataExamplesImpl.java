 ...
 * </p>
 * <ul>
 *   <li>{@link com.modelsolv.reprezen.restapi.datatypes.impl.WithDataExamplesImpl#getDataExamples <em>Data Examples</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class WithDataExamplesImpl extends EObjectImpl implements WithDataExamples {
    ...
    protected EClass eStaticClass() {
        return RestapiPackage.Literals.WITH_DATA_EXAMPLES;
    }
    ...
    public EList<DataExample> getDataExamples() {
        if (dataExamples == null) {
            dataExamples = new EObjectContainmentEList<DataExample>(DataExample.class, this, RestapiPackage.WITH_DATA_EXAMPLES__DATA_EXAMPLES);
        }
        return dataExamples;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case RestapiPackage.WITH_DATA_EXAMPLES__DATA_EXAMPLES:
