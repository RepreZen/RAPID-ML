 ...
 *
 * NOTICE: All information contained herein is, and remains the property of ModelSolv, Inc. See the file license.html in
 * the root directory of this project for further information.
 *******************************************************************************/
public class ResourceFinder {
    ...
    public ResourceFinder(ResourceAPI resourceAPI) {
        ...
        Iterable<ResourceDefinition> allDefinitions = Iterables.concat(
                RestapiModelUtils.getImportedResources(RestapiModelUtils.getZenModel(resourceAPI)),
    ...
    /*
     * ZEN-3978 if a multi-valued reference does not have a corresponding collection resource, try to represent it as an
     * array of hyperlinks to the corresponding object resource
     */
    ...
    public ServiceDataResource findResource(final Structure complexType, final boolean objectNotCollection) {
        ...
        Iterable<ServiceDataResource> definitionsForType = Iterables.filter(resources,
                cardinalityMatches);
