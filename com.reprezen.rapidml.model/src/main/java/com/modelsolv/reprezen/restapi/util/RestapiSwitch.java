 ...
 * @generated
 */
public class RestapiSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RestapiPackage.RESOURCE_DEFINITION: {
			...
			case RestapiPackage.TYPED_MESSAGE: {
			...
			case RestapiPackage.URI_PARAMETER: {
			...
			case RestapiPackage.SOURCE_REFERENCE: {
			...
			case RestapiPackage.PATH_SEGMENT: {
			...
			case RestapiPackage.HAS_STRING_VALUE: {
			...
			case RestapiPackage.HAS_SECURITY_VALUE: {
			...
			case RestapiPackage.REALIZATION_CONTAINER: {
			...
			case RestapiPackage.EXTENSIBLE: {
			...
			case RestapiPackage.CONSTRAINT: {
			...
			case RestapiPackage.SIMPLE_TYPE: {
			...
			case RestapiPackage.SINGLE_VALUE_TYPE: {
			...
			case RestapiPackage.ELEMENT: {
				com.modelsolv.reprezen.restapi.Element element = (com.modelsolv.reprezen.restapi.Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RestapiPackage.REFERENCE_ELEMENT: {
				com.modelsolv.reprezen.restapi.ReferenceElement referenceElement = (com.modelsolv.reprezen.restapi.ReferenceElement)theEObject;
			...
			case RestapiPackage.CONSTRAINABLE_TYPE: {
				com.modelsolv.reprezen.restapi.ConstrainableType constrainableType = (com.modelsolv.reprezen.restapi.ConstrainableType)theEObject;
				T result = caseConstrainableType(constrainableType);
				if (result == null) result = caseExtensible(constrainableType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RestapiPackage.INHERITABLE: {
	 ...
	 * @generated
	 */
	public T caseElement(com.modelsolv.reprezen.restapi.Element object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseReferenceElement(com.modelsolv.reprezen.restapi.ReferenceElement object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseConstrainableType(com.modelsolv.reprezen.restapi.ConstrainableType object) {
		return null;
	}
