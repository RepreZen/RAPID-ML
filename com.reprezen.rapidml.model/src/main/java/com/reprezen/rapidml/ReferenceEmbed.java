 ...
 * '<em><b>Reference Embed</b></em>'. <!-- end-user-doc -->
 *
 *
...
public interface ReferenceEmbed extends ReferenceTreatment {
	 ...
	 *        body='if (getReferenceRealization() == null) {\n return
	 *        ECollections.emptyEList();\n}\nList&lt;ReferenceTreatment&gt;
	 *        allReferenceTreatments =
	 *        Lists.newArrayList(getReferenceRealization().getReferenceTreatments());\nIterable&lt;ReferenceEmbed&gt;
	 ...
	 *        body='if (getReferenceRealization() == null) {\n return
	 *        ECollections.emptyEList();\n}\nreturn
	 *        getReferenceRealization().getReferenceTreatments();'"
	 * @generated
	 */
