 ...
 *   <li>{@link com.reprezen.rapidml.ZenModel#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getResourceAPIs <em>Resource AP Is</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getDataModels <em>Data Models</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getMediaTypesLibrary <em>Media Types Library</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getLinkRelationsLibrary <em>Link Relations Library</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getPrimitiveTypesLibrary <em>Primitive Types Library</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getImports <em>Imports</em>}</li>
 *   <li>{@link com.reprezen.rapidml.ZenModel#getSecuritySchemesLibrary <em>Security Schemes Library</em>}</li>
 * </ul>
 *
...
public interface ZenModel extends Documentable, Extensible, HasTitle {
	...
	/**
	 * Sets the value of the '{@link com.reprezen.rapidml.ZenModel#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link com.reprezen.rapidml.ZenModel#getNamespace <em>Namespace</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link com.reprezen.rapidml.ResourceAPI}.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link com.reprezen.rapidml.ZenModel#getMediaTypesLibrary <em>Media Types Library</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link com.reprezen.rapidml.ZenModel#getLinkRelationsLibrary <em>Link Relations Library</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link com.reprezen.rapidml.ZenModel#getPrimitiveTypesLibrary <em>Primitive Types Library</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link com.reprezen.rapidml.ImportDeclaration}.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link com.reprezen.rapidml.ZenModel#getSecuritySchemesLibrary <em>Security Schemes Library</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
