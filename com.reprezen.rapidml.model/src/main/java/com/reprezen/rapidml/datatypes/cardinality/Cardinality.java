...
public class Cardinality {
	...
	/**
	 * Checks if the lower and upper bounds of the give cardinality are equals to
	 * those of the current element even if the used shortcuts are different.
	 * 
	 * @param that
	 * @return
	 */
	...
	/**
	 * Checks if the given lower and upper bounds are equals to those of the current
	 * element even if the used shortcuts are different.
	 * 
	 * @param lowerBound
	 *            the lower bound
	 * @param upperBound
