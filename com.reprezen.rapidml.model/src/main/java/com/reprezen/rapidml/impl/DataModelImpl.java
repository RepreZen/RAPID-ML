 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.DataModelImpl#getTitle
 * <em>Title</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.DataModelImpl#getOwnedDataTypes
 * <em>Owned Data Types</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.DataModelImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 *
 * @generated
...
public class DataModelImpl extends DocumentableImpl implements DataModel {
	...
	/**
	 * The cached value of the '{@link #getOwnedDataTypes() <em>Owned Data
	...
	public EList<DataType> getOwnedDataTypes() {
		if (ownedDataTypes == null) {
			ownedDataTypes = new EObjectContainmentEList<DataType>(DataType.class, this,
					RapidmlPackage.DATA_MODEL__OWNED_DATA_TYPES);
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HasTitle.class) {
			...
			case RapidmlPackage.HAS_TITLE__TITLE:
				return RapidmlPackage.DATA_MODEL__TITLE;
			default:
				return -1;
			}
		}
