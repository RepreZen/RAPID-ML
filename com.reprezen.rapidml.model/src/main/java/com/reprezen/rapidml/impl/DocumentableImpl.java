 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.DocumentableImpl#getDocumentation
	...
	public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.DOCUMENTABLE__DOCUMENTATION, oldDocumentation, newDocumentation);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject) documentation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RapidmlPackage.DOCUMENTABLE__DOCUMENTATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.DOCUMENTABLE__DOCUMENTATION,
