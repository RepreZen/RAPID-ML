 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ElementImpl#getCardinality
...
public abstract class ElementImpl extends EObjectImpl implements Element {
	...
	public void setCardinality(int[] newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.ELEMENT__CARDINALITY, oldCardinality,
					cardinality));
	}
