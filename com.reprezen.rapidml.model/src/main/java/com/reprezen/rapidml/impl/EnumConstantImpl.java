 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.EnumConstantImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.EnumConstantImpl#getIntegerValue
 * <em>Integer Value</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.EnumConstantImpl#getLiteralValue
 * <em>Literal Value</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.EnumConstantImpl#getEnumeration
...
public class EnumConstantImpl extends DocumentableImpl implements EnumConstant {
	...
	/**
	 * The default value of the '{@link #getIntegerValue() <em>Integer Value</em>}'
	...
	/**
	 * The cached value of the '{@link #getIntegerValue() <em>Integer Value</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getIntegerValue()
	 * @generated
	...
	/**
	 * This is true if the Integer Value attribute has been set. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getLiteralValue() <em>Literal Value</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLiteralValue()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLiteralValue() <em>Literal Value</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLiteralValue()
	 * @generated
	...
	public void setIntegerValue(int newIntegerValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.ENUM_CONSTANT__INTEGER_VALUE,
					oldIntegerValue, integerValue, !oldIntegerValueESet));
	}
	...
	public void unsetIntegerValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, RapidmlPackage.ENUM_CONSTANT__INTEGER_VALUE,
					oldIntegerValue, INTEGER_VALUE_EDEFAULT, oldIntegerValueESet));
	}
	...
	public void setLiteralValue(String newLiteralValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.ENUM_CONSTANT__LITERAL_VALUE,
	...
	public Enumeration getEnumeration() {
		if (eContainerFeatureID() != RapidmlPackage.ENUM_CONSTANT__ENUMERATION)
			return null;
	...
	public void setEnumeration(Enumeration newEnumeration) {
		if (newEnumeration != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.ENUM_CONSTANT__ENUMERATION && newEnumeration != null)) {
			...
			if (newEnumeration != null)
				msgs = ((InternalEObject) newEnumeration).eInverseAdd(this, RapidmlPackage.ENUMERATION__ENUM_CONSTANTS,
						Enumeration.class, msgs);
			msgs = basicSetEnumeration(newEnumeration, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.ENUM_CONSTANT__ENUMERATION,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RapidmlPackage.ENUM_CONSTANT__ENUMERATION:
			return eInternalContainer().eInverseRemove(this, RapidmlPackage.ENUMERATION__ENUM_CONSTANTS,
					Enumeration.class, msgs);
		}
