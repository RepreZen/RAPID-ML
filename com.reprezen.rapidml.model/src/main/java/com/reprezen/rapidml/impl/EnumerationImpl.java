 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.EnumerationImpl#getEnumConstants
 * <em>Enum Constants</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.EnumerationImpl#getBaseType
 * <em>Base Type</em>}</li>
 * </ul>
 *
 * @generated
...
public class EnumerationImpl extends SingleValueTypeImpl implements Enumeration {
	/**
	 * The cached value of the '{@link #getEnumConstants() <em>Enum Constants</em>}'
	...
	public EList<EnumConstant> getEnumConstants() {
		if (enumConstants == null) {
			enumConstants = new EObjectContainmentWithInverseEList<EnumConstant>(EnumConstant.class, this,
					RapidmlPackage.ENUMERATION__ENUM_CONSTANTS, RapidmlPackage.ENUM_CONSTANT__ENUMERATION);
		}
		...
		if (baseType != null && baseType.eIsProxy()) {
			...
			if (baseType != oldBaseType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RapidmlPackage.ENUMERATION__BASE_TYPE,
	...
	public void setBaseType(PrimitiveType newBaseType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.ENUMERATION__BASE_TYPE, oldBaseType,
					baseType));
	}
