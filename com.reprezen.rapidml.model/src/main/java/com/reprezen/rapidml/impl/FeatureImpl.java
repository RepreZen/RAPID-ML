 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#getCardinality
 * <em>Cardinality</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#getExtensions
 * <em>Extensions</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#getContainingDataType
 * <em>Containing Data Type</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#isRestriction
 * <em>Restriction</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#isReadOnly
 * <em>Read Only</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.FeatureImpl#isKey
 * <em>Key</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class FeatureImpl extends DocumentableImpl implements Feature {
	...
	/**
	 * The default value of the '{@link #isRestriction() <em>Restriction</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isRestriction()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isRestriction() <em>Restriction</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isRestriction()
	 * @generated
	...
	public void setCardinality(int[] newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.FEATURE__CARDINALITY, oldCardinality,
					cardinality));
	}
	...
	public EList<Extension> getExtensions() {
		if (extensions == null) {
			extensions = new EObjectContainmentEList<Extension>(Extension.class, this,
					RapidmlPackage.FEATURE__EXTENSIONS);
		}
		return extensions;
	}
	...
	public Structure getContainingDataType() {
		if (eContainerFeatureID() != RapidmlPackage.FEATURE__CONTAINING_DATA_TYPE)
			return null;
	...
	public NotificationChain basicSetContainingDataType(Structure newContainingDataType, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingDataType, RapidmlPackage.FEATURE__CONTAINING_DATA_TYPE,
				msgs);
		return msgs;
	}
	...
	public void setContainingDataType(Structure newContainingDataType) {
		if (newContainingDataType != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.FEATURE__CONTAINING_DATA_TYPE
						&& newContainingDataType != null)) {
			...
			if (newContainingDataType != null)
				msgs = ((InternalEObject) newContainingDataType).eInverseAdd(this,
						RapidmlPackage.STRUCTURE__OWNED_FEATURES, Structure.class, msgs);
			msgs = basicSetContainingDataType(newContainingDataType, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.FEATURE__CONTAINING_DATA_TYPE,
					newContainingDataType, newContainingDataType));
	}
	...
	public void setRestriction(boolean newRestriction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.FEATURE__RESTRICTION, oldRestriction,
					restriction));
	}
	...
	public void setReadOnly(boolean newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.FEATURE__READ_ONLY, oldReadOnly,
					readOnly));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RapidmlPackage.FEATURE__CONTAINING_DATA_TYPE:
			return eInternalContainer().eInverseRemove(this, RapidmlPackage.STRUCTURE__OWNED_FEATURES, Structure.class,
					msgs);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Element.class) {
			...
			case RapidmlPackage.FEATURE__CARDINALITY:
				return RapidmlPackage.ELEMENT__CARDINALITY;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Element.class) {
			...
			case RapidmlPackage.ELEMENT__CARDINALITY:
				return RapidmlPackage.FEATURE__CARDINALITY;
			default:
				return -1;
			}
		}
		if (baseClass == Extensible.class) {
			...
			case RapidmlPackage.EXTENSIBLE__EXTENSIONS:
				return RapidmlPackage.FEATURE__EXTENSIONS;
			default:
				return -1;
			}
		}
