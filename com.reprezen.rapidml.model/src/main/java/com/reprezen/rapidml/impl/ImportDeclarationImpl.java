 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.ImportDeclarationImpl#getImportURI
 * <em>Import URI</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ImportDeclarationImpl#getImportedNamespace
 * <em>Imported Namespace</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ImportDeclarationImpl#getAlias
 * <em>Alias</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ImportDeclarationImpl#getImportedModel
...
public class ImportDeclarationImpl extends EObjectImpl implements ImportDeclaration {
	...
	/**
	 * The default value of the '{@link #getImportedNamespace() <em>Imported
	...
	/**
	 * The cached value of the '{@link #getImportedNamespace() <em>Imported
	 * Namespace</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getImportedNamespace()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getImportedModel() <em>Imported Model</em>}'
	...
	public void setImportURI(String newImportURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.IMPORT_DECLARATION__IMPORT_URI,
	...
	public void setImportedNamespace(String newImportedNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.IMPORT_DECLARATION__IMPORTED_NAMESPACE,
	...
	public void setAlias(String newAlias) {
		...
		alias = newAlias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.IMPORT_DECLARATION__ALIAS, oldAlias,
					alias));
	}
			...
			if (importedModel != oldImportedModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.IMPORT_DECLARATION__IMPORTED_MODEL, oldImportedModel, importedModel));
			}
		}
	...
	public void setImportedModel(ZenModel newImportedModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.IMPORT_DECLARATION__IMPORTED_MODEL,
					oldImportedModel, importedModel));
	}
