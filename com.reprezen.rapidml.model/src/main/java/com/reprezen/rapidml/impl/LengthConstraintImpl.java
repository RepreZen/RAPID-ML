...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Length
 * Constraint</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.LengthConstraintImpl#getMinLength
 * <em>Min Length</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.LengthConstraintImpl#getMaxLength
 * <em>Max Length</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.LengthConstraintImpl#getLength
 * <em>Length</em>}</li>
 * </ul>
 *
 * @generated
...
public class LengthConstraintImpl extends ConstraintImpl implements LengthConstraint {
	...
	/**
	 * This is true if the Min Length attribute has been set. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * This is true if the Max Length attribute has been set. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	public void setMinLength(int newMinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.LENGTH_CONSTRAINT__MIN_LENGTH,
					oldMinLength, minLength, !oldMinLengthESet));
	}
	...
	public void unsetMinLength() {
		...
		minLengthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, RapidmlPackage.LENGTH_CONSTRAINT__MIN_LENGTH,
					oldMinLength, MIN_LENGTH_EDEFAULT, oldMinLengthESet));
	}
	...
	public void setMaxLength(int newMaxLength) {
		...
		maxLengthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.LENGTH_CONSTRAINT__MAX_LENGTH,
					oldMaxLength, maxLength, !oldMaxLengthESet));
	}
	...
	public void unsetMaxLength() {
		...
		maxLengthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, RapidmlPackage.LENGTH_CONSTRAINT__MAX_LENGTH,
					oldMaxLength, MAX_LENGTH_EDEFAULT, oldMaxLengthESet));
	}
