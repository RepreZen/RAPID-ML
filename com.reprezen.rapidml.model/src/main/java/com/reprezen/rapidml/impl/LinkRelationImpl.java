 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.LinkRelationImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.LinkRelationImpl#getSpecURL <em>Spec
 * URL</em>}</li>
 * </ul>
 *
 * @generated
...
public class LinkRelationImpl extends DocumentableImpl implements LinkRelation {
	...
	public void setSpecURL(String newSpecURL) {
		...
		specURL = newSpecURL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.LINK_RELATION__SPEC_URL, oldSpecURL,
					specURL));
	}
