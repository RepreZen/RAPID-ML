 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.MediaTypeImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MediaTypeImpl#getSpecURL <em>Spec
 * URL</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MediaTypeImpl#getDerivedFrom <em>Derived
 * From</em>}</li>
 * </ul>
 *
 * @generated
...
public class MediaTypeImpl extends RESTElementImpl implements MediaType {
	...
	/**
	 * The cached value of the '{@link #getDerivedFrom() <em>Derived From</em>}'
	...
	public void setSpecURL(String newSpecURL) {
		...
		specURL = newSpecURL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.MEDIA_TYPE__SPEC_URL, oldSpecURL,
					specURL));
	}
	...
	public EList<MediaType> getDerivedFrom() {
		if (derivedFrom == null) {
			derivedFrom = new EObjectResolvingEList<MediaType>(MediaType.class, this,
					RapidmlPackage.MEDIA_TYPE__DERIVED_FROM);
		}
		return derivedFrom;
	}
