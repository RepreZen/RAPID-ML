 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.MessageParameterImpl#getContainingMessage
 * <em>Containing Message</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MessageParameterImpl#getHttpLocation
 * <em>Http Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageParameterImpl extends ParameterImpl implements MessageParameter {
	/**
	 * The default value of the '{@link #getHttpLocation() <em>Http Location</em>}'
	...
	/**
	 * The cached value of the '{@link #getHttpLocation() <em>Http Location</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getHttpLocation()
	 * @generated
	...
	public TypedMessage getContainingMessage() {
		if (eContainerFeatureID() != RapidmlPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE)
			return null;
	...
	public NotificationChain basicSetContainingMessage(TypedMessage newContainingMessage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingMessage,
				RapidmlPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE, msgs);
		return msgs;
	}
	...
	public void setContainingMessage(TypedMessage newContainingMessage) {
		if (newContainingMessage != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE
						&& newContainingMessage != null)) {
			...
			if (newContainingMessage != null)
				msgs = ((InternalEObject) newContainingMessage).eInverseAdd(this,
						RapidmlPackage.TYPED_MESSAGE__PARAMETERS, TypedMessage.class, msgs);
			msgs = basicSetContainingMessage(newContainingMessage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE,
					newContainingMessage, newContainingMessage));
	}
	...
	public void setHttpLocation(HttpMessageParameterLocation newHttpLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.MESSAGE_PARAMETER__HTTP_LOCATION,
					oldHttpLocation, httpLocation));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RapidmlPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE:
			return eInternalContainer().eInverseRemove(this, RapidmlPackage.TYPED_MESSAGE__PARAMETERS,
					TypedMessage.class, msgs);
		}
