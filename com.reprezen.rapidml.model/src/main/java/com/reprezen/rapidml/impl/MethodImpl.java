 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.MethodImpl#getSecuredBy <em>Secured
 * By</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MethodImpl#getRequest
 * <em>Request</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MethodImpl#getResponses
 * <em>Responses</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MethodImpl#getId <em>Id</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MethodImpl#getHttpMethod <em>Http
 * Method</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.MethodImpl#getContainingResourceDefinition
...
public class MethodImpl extends RESTElementImpl implements Method {
	...
	/**
	 * The cached value of the '{@link #getRequest() <em>Request</em>}' containment
	...
	/**
	 * The default value of the '{@link #getHttpMethod() <em>Http Method</em>}'
	...
	/**
	 * The cached value of the '{@link #getHttpMethod() <em>Http Method</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getHttpMethod()
	 * @generated
	...
	public EList<AuthenticationMethod> getSecuredBy() {
		if (securedBy == null) {
			securedBy = new EObjectContainmentEList<AuthenticationMethod>(AuthenticationMethod.class, this,
					RapidmlPackage.METHOD__SECURED_BY);
		}
		return securedBy;
	}
	...
	public NotificationChain basicSetRequest(TypedRequest newRequest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.METHOD__REQUEST, oldRequest, newRequest);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRequest(TypedRequest newRequest) {
		if (newRequest != request) {
			...
			if (request != null)
				msgs = ((InternalEObject) request).eInverseRemove(this, RapidmlPackage.TYPED_REQUEST__CONTAINING_METHOD,
						TypedRequest.class, msgs);
			if (newRequest != null)
				msgs = ((InternalEObject) newRequest).eInverseAdd(this, RapidmlPackage.TYPED_REQUEST__CONTAINING_METHOD,
						TypedRequest.class, msgs);
			msgs = basicSetRequest(newRequest, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.METHOD__REQUEST, newRequest,
					newRequest));
	}
	...
	public EList<TypedResponse> getResponses() {
		if (responses == null) {
			responses = new EObjectContainmentWithInverseEList<TypedResponse>(TypedResponse.class, this,
					RapidmlPackage.METHOD__RESPONSES, RapidmlPackage.TYPED_RESPONSE__CONTAINING_METHOD);
		}
		return responses;
	}
	...
	public void setHttpMethod(HTTPMethods newHttpMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.METHOD__HTTP_METHOD, oldHttpMethod,
					httpMethod));
	}
	...
	public ResourceDefinition getContainingResourceDefinition() {
		if (eContainerFeatureID() != RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContainingResourceDefinition(ResourceDefinition newContainingResourceDefinition,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingResourceDefinition,
				RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION, msgs);
		return msgs;
	}
	...
	public void setContainingResourceDefinition(ResourceDefinition newContainingResourceDefinition) {
		if (newContainingResourceDefinition != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION
			...
			if (newContainingResourceDefinition != null)
				msgs = ((InternalEObject) newContainingResourceDefinition).eInverseAdd(this,
						RapidmlPackage.RESOURCE_DEFINITION__METHODS, ResourceDefinition.class, msgs);
			msgs = basicSetContainingResourceDefinition(newContainingResourceDefinition, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION,
		...
		case RapidmlPackage.METHOD__REQUEST:
			if (request != null)
				msgs = ((InternalEObject) request).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RapidmlPackage.METHOD__REQUEST, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION:
			return eInternalContainer().eInverseRemove(this, RapidmlPackage.RESOURCE_DEFINITION__METHODS,
					ResourceDefinition.class, msgs);
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HasSecurityValue.class) {
			...
			case RapidmlPackage.HAS_SECURITY_VALUE__SECURED_BY:
				return RapidmlPackage.METHOD__SECURED_BY;
			default:
				return -1;
			}
		}
