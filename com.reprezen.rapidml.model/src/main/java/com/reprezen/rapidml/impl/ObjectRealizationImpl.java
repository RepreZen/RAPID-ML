 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.ObjectRealizationImpl#getExtensions
 * <em>Extensions</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ObjectRealizationImpl#getExclusivePropertyList
 * <em>Exclusive Property List</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ObjectRealizationImpl#getOverriddenPropertyList
 * <em>Overridden Property List</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ObjectRealizationImpl#getExcludedProperties
 * <em>Excluded Properties</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ObjectRealizationImpl#getRealizationContainer
...
public class ObjectRealizationImpl extends EObjectImpl implements ObjectRealization {
	...
	/**
	 * The cached value of the '{@link #getExclusivePropertyList() <em>Exclusive
	 * Property List</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getOverriddenPropertyList() <em>Overridden
	 * Property List</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getExcludedProperties() <em>Excluded
	 * Properties</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	public EList<Extension> getExtensions() {
		if (extensions == null) {
			extensions = new EObjectContainmentEList<Extension>(Extension.class, this,
					RapidmlPackage.OBJECT_REALIZATION__EXTENSIONS);
		}
		return extensions;
	}
	...
	public EList<PropertyRealization> getExclusivePropertyList() {
		if (exclusivePropertyList == null) {
			exclusivePropertyList = new EObjectContainmentEList<PropertyRealization>(PropertyRealization.class, this,
					RapidmlPackage.OBJECT_REALIZATION__EXCLUSIVE_PROPERTY_LIST);
		}
	...
	public EList<PropertyRealization> getOverriddenPropertyList() {
		if (overriddenPropertyList == null) {
			overriddenPropertyList = new EObjectContainmentEList<PropertyRealization>(PropertyRealization.class, this,
					RapidmlPackage.OBJECT_REALIZATION__OVERRIDDEN_PROPERTY_LIST);
		}
	...
	public EList<com.reprezen.rapidml.Feature> getExcludedProperties() {
		if (excludedProperties == null) {
			excludedProperties = new EObjectResolvingEList<com.reprezen.rapidml.Feature>(
					com.reprezen.rapidml.Feature.class, this, RapidmlPackage.OBJECT_REALIZATION__EXCLUDED_PROPERTIES);
		}
	...
	public EList<PropertyRealization> getAllIncludedProperties() {
		...
		if (container instanceof ReferenceRealization
				&& ((ReferenceRealization) container).getRealizationType() == ReferenceRealizationEnum.LINK) {
			...
			Collection<PropertyRealization> overridden = com.google.common.collect.Collections2
					.filter(getOverriddenPropertyList(), new com.google.common.base.Predicate<PropertyRealization>() {
						...
						public boolean apply(PropertyRealization input) {
							return com.reprezen.rapidml.util.InheritanceUtils.sameOrOverrides(input.getBaseProperty(),
									feature);
						}
					});
	...
	public RealizationContainer getRealizationContainer() {
		if (eContainerFeatureID() != RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER)
			return null;
	...
	public NotificationChain basicSetRealizationContainer(RealizationContainer newRealizationContainer,
		...
		msgs = eBasicSetContainer((InternalEObject) newRealizationContainer,
				RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER, msgs);
		return msgs;
	}
	...
	public void setRealizationContainer(RealizationContainer newRealizationContainer) {
		if (newRealizationContainer != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER
						&& newRealizationContainer != null)) {
			...
			if (newRealizationContainer != null)
				msgs = ((InternalEObject) newRealizationContainer).eInverseAdd(this,
						RapidmlPackage.REALIZATION_CONTAINER__INLINE_OBJECT_REALIZATION, RealizationContainer.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER, newRealizationContainer,
					newRealizationContainer));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RapidmlPackage.OBJECT_REALIZATION__REALIZATION_CONTAINER:
			return eInternalContainer().eInverseRemove(this,
					RapidmlPackage.REALIZATION_CONTAINER__INLINE_OBJECT_REALIZATION, RealizationContainer.class, msgs);
		}
