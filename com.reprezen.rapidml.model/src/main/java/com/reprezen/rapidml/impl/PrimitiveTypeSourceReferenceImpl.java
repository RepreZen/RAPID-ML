 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.PrimitiveTypeSourceReferenceImpl#getSimpleType
...
public class PrimitiveTypeSourceReferenceImpl extends SourceReferenceImpl implements PrimitiveTypeSourceReference {
	/**
	 * The cached value of the '{@link #getSimpleType() <em>Simple Type</em>}'
			...
			if (simpleType != oldSimpleType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.PRIMITIVE_TYPE_SOURCE_REFERENCE__SIMPLE_TYPE, oldSimpleType, simpleType));
			}
		}
		return simpleType;
	}
