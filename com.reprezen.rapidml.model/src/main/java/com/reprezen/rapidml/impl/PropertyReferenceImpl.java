 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.PropertyReferenceImpl#getConceptualFeature
...
public class PropertyReferenceImpl extends SourceReferenceImpl implements PropertyReference {
	/**
	 * The cached value of the '{@link #getConceptualFeature() <em>Conceptual
			...
			if (conceptualFeature != oldConceptualFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.PROPERTY_REFERENCE__CONCEPTUAL_FEATURE, oldConceptualFeature,
							conceptualFeature));
			}
		}
	...
	public void setConceptualFeature(com.reprezen.rapidml.PrimitiveProperty newConceptualFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.PROPERTY_REFERENCE__CONCEPTUAL_FEATURE,
					oldConceptualFeature, conceptualFeature));
	}
