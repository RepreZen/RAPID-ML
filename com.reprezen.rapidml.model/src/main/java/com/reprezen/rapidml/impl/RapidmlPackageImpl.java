...
public class RapidmlPackageImpl extends EPackageImpl implements RapidmlPackage {
	 ...
	 *
	 * <p>
	 * This method is used to initialize {@link RapidmlPackage#eINSTANCE} when that
	...
	public static RapidmlPackage init() {
		if (isInited)
			return (RapidmlPackage) EPackage.Registry.INSTANCE.getEPackage(RapidmlPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredRapidmlPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		RapidmlPackageImpl theRapidmlPackage = registeredRapidmlPackage instanceof RapidmlPackageImpl
				? (RapidmlPackageImpl) registeredRapidmlPackage
				: new RapidmlPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(resourceDefinitionEClass, ResourceDefinition.class, "ResourceDefinition", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getResourceDefinition_Methods(), this.getMethod(), this.getMethod_ContainingResourceDefinition(),
				"methods", null, 0, -1, ResourceDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceDefinition_MediaTypes(), this.getMediaType(), null, "mediaTypes", null, 0, -1,
				ResourceDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResourceDefinition_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				ResourceDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getResourceDefinition_AllMediaTypes(), this.getMediaType(), null, "allMediaTypes", null, 0, -1,
				ResourceDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceDefinition_URI(), this.getURI(), null, "URI", null, 0, 1, ResourceDefinition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(typedMessageEClass, TypedMessage.class, "TypedMessage", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTypedMessage_Parameters(), this.getMessageParameter(),
				this.getMessageParameter_ContainingMessage(), "parameters", null, 0, -1, TypedMessage.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTypedMessage_ResourceType(), this.getResourceDefinition(), null, "resourceType", null, 0, 1,
				TypedMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTypedMessage_UseParentTypeReference(), ecorePackage.getEBoolean(), "useParentTypeReference",
				null, 0, 1, TypedMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTypedMessage_MediaTypes(), this.getMediaType(), null, "mediaTypes", null, 0, -1,
				TypedMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(typedMessageEClass, this.getExample(), "getAllExamples", 0, -1, IS_UNIQUE, IS_ORDERED);

		EOperation op = addEOperation(typedMessageEClass, ecorePackage.getEBoolean(), "isIncluded", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getFeature(), "feature", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(typedMessageEClass, this.getPropertyRealization(), "getIncludedProperties", 0, -1, IS_UNIQUE,
				IS_ORDERED);
		...
		initEReference(getMethod_Request(), this.getTypedRequest(), this.getTypedRequest_ContainingMethod(), "request",
				null, 0, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethod_Responses(), this.getTypedResponse(), this.getTypedResponse_ContainingMethod(),
				"responses", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethod_Id(), ecorePackage.getEString(), "id", null, 0, 1, Method.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMethod_HttpMethod(), this.getHTTPMethods(), "httpMethod", null, 0, 1, Method.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethod_ContainingResourceDefinition(), this.getResourceDefinition(),
				this.getResourceDefinition_Methods(), "containingResourceDefinition", null, 0, 1, Method.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getParameter_Name(), ecorePackage.getEString(), "name", null, 0, 1, Parameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameter_Required(), ecorePackage.getEBoolean(), "required", null, 0, 1, Parameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameter_Default(), ecorePackage.getEString(), "default", null, 0, 1, Parameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParameter_Fixed(), ecorePackage.getEString(), "fixed", null, 0, 1, Parameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getParameter_SourceReference(), this.getSourceReference(),
				this.getSourceReference_ContainingParameter(), "sourceReference", null, 0, 1, Parameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(restElementEClass, RESTElement.class, "RESTElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(documentationEClass, Documentation.class, "Documentation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDocumentation_Text(), ecorePackage.getEString(), "text", null, 0, 1, Documentation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(documentableEClass, Documentable.class, "Documentable", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDocumentable_Documentation(), this.getDocumentation(), null, "documentation", null, 0, 1,
				Documentable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(mediaTypeEClass, MediaType.class, "MediaType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMediaType_Name(), ecorePackage.getEString(), "name", null, 0, 1, MediaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMediaType_SpecURL(), ecorePackage.getEString(), "specURL", null, 0, 1, MediaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMediaType_DerivedFrom(), this.getMediaType(), null, "derivedFrom", null, 0, -1,
				MediaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(typedRequestEClass, TypedRequest.class, "TypedRequest", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTypedRequest_ContainingMethod(), this.getMethod(), this.getMethod_Request(),
				"containingMethod", null, 0, 1, TypedRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(typedResponseEClass, TypedResponse.class, "TypedResponse", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTypedResponse_StatusCode(), ecorePackage.getEInt(), "statusCode", "-1", 0, 1,
				TypedResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTypedResponse_ContainingMethod(), this.getMethod(), this.getMethod_Responses(),
				"containingMethod", null, 0, 1, TypedResponse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(uriParameterEClass, URIParameter.class, "URIParameter", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getURIParameter_UriSegment(), this.getURISegmentWithParameter(), null, "uriSegment", null, 0, 1,
				URIParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getURIParameter_ContainingURI(), this.getURI(), this.getURI_UriParameters(), "containingURI",
				null, 0, 1, URIParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(templateParameterEClass, TemplateParameter.class, "TemplateParameter", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(collectionResourceEClass, CollectionResource.class, "CollectionResource", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCollectionResource_CollectionParameters(), this.getCollectionParameter(),
				this.getCollectionParameter_ContainingResourceDefinition(), "collectionParameters", null, 0, -1,
				CollectionResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCollectionResource_ReferenceElements(), this.getCollectionReferenceElement(), null,
				"referenceElements", null, 0, -1, CollectionResource.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCollectionResource_ResourceRealizationKind(), this.getCollectionRealizationEnum(),
				"resourceRealizationKind", null, 0, 1, CollectionResource.class, IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(objectResourceEClass, ObjectResource.class, "ObjectResource", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(collectionParameterEClass, CollectionParameter.class, "CollectionParameter", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCollectionParameter_ContainingResourceDefinition(), this.getCollectionResource(),
				this.getCollectionResource_CollectionParameters(), "containingResourceDefinition", null, 0, 1,
				CollectionParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(propertyReferenceEClass, PropertyReference.class, "PropertyReference", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPropertyReference_ConceptualFeature(), this.getPrimitiveProperty(), null, "conceptualFeature",
				null, 0, 1, PropertyReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(sourceReferenceEClass, SourceReference.class, "SourceReference", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSourceReference_ContainingParameter(), this.getParameter(),
				this.getParameter_SourceReference(), "containingParameter", null, 0, 1, SourceReference.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(messageParameterEClass, MessageParameter.class, "MessageParameter", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMessageParameter_ContainingMessage(), this.getTypedMessage(),
				this.getTypedMessage_Parameters(), "containingMessage", null, 0, 1, MessageParameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMessageParameter_HttpLocation(), this.getHttpMessageParameterLocation(), "httpLocation", null,
				0, 1, MessageParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(zenModelEClass, ZenModel.class, "ZenModel", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getZenModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, ZenModel.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getZenModel_Namespace(), ecorePackage.getEString(), "namespace", null, 0, 1, ZenModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_ResourceAPIs(), this.getResourceAPI(), null, "resourceAPIs", null, 0, -1,
				ZenModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_DataModels(), this.getDataModel(), null, "dataModels", null, 0, -1, ZenModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_MediaTypesLibrary(), this.getMediaTypesLibrary(), null, "mediaTypesLibrary", null, 0,
				1, ZenModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_LinkRelationsLibrary(), this.getLinkRelationsLibrary(), null, "linkRelationsLibrary",
				null, 0, 1, ZenModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_PrimitiveTypesLibrary(), this.getPrimitiveTypesLibrary(), null,
				"primitiveTypesLibrary", null, 0, 1, ZenModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_Imports(), this.getImportDeclaration(), null, "imports", null, 0, -1, ZenModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getZenModel_SecuritySchemesLibrary(), this.getSecuritySchemeLibrary(), null,
				"securitySchemesLibrary", null, 0, 1, ZenModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resourceAPIEClass, ResourceAPI.class, "ResourceAPI", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResourceAPI_Name(), ecorePackage.getEString(), "name", null, 0, 1, ResourceAPI.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResourceAPI_Version(), ecorePackage.getEString(), "version", null, 0, 1, ResourceAPI.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResourceAPI_BaseURI(), ecorePackage.getEString(), "baseURI", null, 0, 1, ResourceAPI.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_OwnedResourceDefinitions(), this.getResourceDefinition(), null,
				"ownedResourceDefinitions", null, 0, -1, ResourceAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_ServiceDataModels(), this.getDataModel(), null, "serviceDataModels", null, 0, -1,
				ResourceAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_Formats(), this.getMediaType(), null, "formats", null, 0, -1, ResourceAPI.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_DefinedMediaTypes(), this.getMediaType(), null, "definedMediaTypes", null, 0, -1,
				ResourceAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_DefinedLinkRelations(), this.getLinkRelation(), null, "definedLinkRelations",
				null, 0, -1, ResourceAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_DefaultReferenceRealizations(), this.getReferenceRealization(), null,
				"defaultReferenceRealizations", null, 0, -1, ResourceAPI.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceAPI_AutoRealizations(), this.getRealizationModelLocation(), null, "autoRealizations",
				null, 0, -1, ResourceAPI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(serviceDataResourceEClass, ServiceDataResource.class, "ServiceDataResource", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getServiceDataResource_Default(), ecorePackage.getEBoolean(), "default", null, 0, 1,
				ServiceDataResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getServiceDataResource_DefinedLinkDescriptors(), this.getNamedLinkDescriptor(), null,
				"definedLinkDescriptors", null, 0, -1, ServiceDataResource.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(serviceDataResourceEClass, this.getNamedLinkDescriptor(), "getDefaultLinkDescriptor", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		op = addEOperation(serviceDataResourceEClass, ecorePackage.getEBoolean(), "isIncluded", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getFeature(), "feature", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(serviceDataResourceEClass, this.getReferenceLink(), "getReferenceLinks", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(serviceDataResourceEClass, this.getReferenceTreatment(), "getAllReferenceTreatments", 0, -1,
				IS_UNIQUE, IS_ORDERED);

		addEOperation(serviceDataResourceEClass, this.getPropertyRealization(), "getIncludedProperties", 0, -1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(referenceTreatmentEClass, ReferenceTreatment.class, "ReferenceTreatment", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceTreatment_ReferenceElement(), this.getReferenceElement(), null, "referenceElement",
				null, 0, 1, ReferenceTreatment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceTreatment_ReferenceRealization(), this.getReferenceRealization(), null,
				"referenceRealization", null, 0, 1, ReferenceTreatment.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceTreatment_OwnedReferenceRealization(), this.getReferenceRealization(), null,
				"ownedReferenceRealization", null, 0, 1, ReferenceTreatment.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(referenceTreatmentEClass, this.getReferenceEmbed(), "getEmbedHierarchy", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(referenceTreatmentEClass, this.getObjectRealization(), "getLinkDescriptor", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(referenceRealizationEClass, ReferenceRealization.class, "ReferenceRealization", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceRealization_TargetResource(), this.getResourceDefinition(), null, "targetResource",
				null, 0, 1, ReferenceRealization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceRealization_RealizationType(), this.getReferenceRealizationEnum(), "realizationType",
				null, 0, 1, ReferenceRealization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceRealization_MultiValued(), ecorePackage.getEBoolean(), "multiValued", "false", 0, 1,
				ReferenceRealization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(referenceRealizationEClass, this.getObjectRealization(), "getLinkDescriptor", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(referenceLinkEClass, ReferenceLink.class, "ReferenceLink", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getReferenceLink_Name(), ecorePackage.getEString(), "name", null, 0, 1, ReferenceLink.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceLink_LinkRelation(), this.getLinkRelation(), null, "linkRelation", null, 0, 1,
				ReferenceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceLink_CollectionRealizationLevel(), this.getCollectionRealizationLevelObject(),
				"collectionRealizationLevel", null, 0, 1, ReferenceLink.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(referenceLinkEClass, this.getResourceDefinition(), "getTargetResource", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(referenceEmbedEClass, ReferenceEmbed.class, "ReferenceEmbed", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		addEOperation(referenceEmbedEClass, this.getReferenceTreatment(), "getAllNestedReferenceTreatments", 0, -1,
				IS_UNIQUE, IS_ORDERED);

		addEOperation(referenceEmbedEClass, this.getReferenceTreatment(), "getNestedReferenceTreatments", 0, -1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(namedLinkDescriptorEClass, NamedLinkDescriptor.class, "NamedLinkDescriptor", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNamedLinkDescriptor_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				NamedLinkDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNamedLinkDescriptor_Default(), ecorePackage.getEBoolean(), "default", null, 0, 1,
				NamedLinkDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(pathSegmentEClass, PathSegment.class, "PathSegment", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPathSegment_ReferenceElement(), this.getReferenceElement(), null, "referenceElement", null, 0,
				1, PathSegment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(primitiveTypeSourceReferenceEClass, PrimitiveTypeSourceReference.class,
				"PrimitiveTypeSourceReference", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrimitiveTypeSourceReference_SimpleType(), this.getPrimitiveType(), null, "simpleType", null,
				0, 1, PrimitiveTypeSourceReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(primitiveTypeSourceReferenceEClass, this.getSingleValueType(), "getType", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(primitiveTypeSourceReferenceEClass, this.getConstraint(), "getConstraints", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(uriEClass, com.reprezen.rapidml.URI.class, "URI", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getURI_Segments(), this.getURISegment(), null, "segments", null, 1, -1,
				com.reprezen.rapidml.URI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getURI_UriParameters(), this.getURIParameter(), this.getURIParameter_ContainingURI(),
				"uriParameters", null, 0, -1, com.reprezen.rapidml.URI.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(uriSegmentEClass, URISegment.class, "URISegment", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getURISegment_Name(), ecorePackage.getEString(), "name", null, 0, 1, URISegment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(uriSegmentWithParameterEClass, URISegmentWithParameter.class, "URISegmentWithParameter",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(propertyRealizationEClass, PropertyRealization.class, "PropertyRealization", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPropertyRealization_BaseProperty(), this.getFeature(), null, "baseProperty", null, 1, 1,
				PropertyRealization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPropertyRealization_Cardinality(), this.getCardinalityOverride(), "cardinality", null, 0, 1,
				PropertyRealization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(propertyRealizationEClass, this.getPrimitiveType(), "getPrimitiveType", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(linkRelationEClass, LinkRelation.class, "LinkRelation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLinkRelation_Name(), ecorePackage.getEString(), "name", null, 0, 1, LinkRelation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkRelation_SpecURL(), ecorePackage.getEString(), "specURL", null, 0, 1, LinkRelation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(withExamplesEClass, WithExamples.class, "WithExamples", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWithExamples_Examples(), this.getExample(), null, "examples", null, 0, -1, WithExamples.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(inlineExampleEClass, InlineExample.class, "InlineExample", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInlineExample_Body(), ecorePackage.getEString(), "body", null, 1, 1, InlineExample.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(externalExampleEClass, ExternalExample.class, "ExternalExample", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExternalExample_Path(), ecorePackage.getEString(), "path", null, 1, 1, ExternalExample.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(externalExampleEClass, ecorePackage.getEString(), "getBody", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(hasStringValueEClass, HasStringValue.class, "HasStringValue", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(importDeclarationEClass, ImportDeclaration.class, "ImportDeclaration", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getImportDeclaration_ImportURI(), ecorePackage.getEString(), "importURI", null, 1, 1,
				ImportDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getImportDeclaration_ImportedNamespace(), ecorePackage.getEString(), "importedNamespace", null,
				0, 1, ImportDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImportDeclaration_Alias(), ecorePackage.getEString(), "alias", null, 0, 1,
				ImportDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getImportDeclaration_ImportedModel(), this.getZenModel(), null, "importedModel", null, 0, 1,
				ImportDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(objectRealizationEClass, ObjectRealization.class, "ObjectRealization", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getObjectRealization_ExclusivePropertyList(), this.getPropertyRealization(), null,
				"exclusivePropertyList", null, 0, -1, ObjectRealization.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getObjectRealization_OverriddenPropertyList(), this.getPropertyRealization(), null,
				"overriddenPropertyList", null, 0, -1, ObjectRealization.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getObjectRealization_ExcludedProperties(), this.getFeature(), null, "excludedProperties", null,
				0, -1, ObjectRealization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getObjectRealization_RealizationContainer(), this.getRealizationContainer(),
				this.getRealizationContainer_InlineObjectRealization(), "realizationContainer", null, 0, 1,
				ObjectRealization.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(objectRealizationEClass, this.getStructure(), "getDataType", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(objectRealizationEClass, this.getPropertyRealization(), "getAllIncludedProperties", 0, -1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(collectionReferenceElementEClass, CollectionReferenceElement.class, "CollectionReferenceElement",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(collectionReferenceElementEClass, ecorePackage.getEString(), "getName", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(hasSecurityValueEClass, HasSecurityValue.class, "HasSecurityValue", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHasSecurityValue_SecuredBy(), this.getAuthenticationMethod(), null, "securedBy", null, 0, -1,
				HasSecurityValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(securitySchemeEClass, SecurityScheme.class, "SecurityScheme", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSecurityScheme_Name(), ecorePackage.getEString(), "name", null, 0, 1, SecurityScheme.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSecurityScheme_Type(), this.getAuthenticationTypes(), "type", null, 0, 1,
				SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getSecurityScheme_Scopes(), this.getSecurityScope(), null, "scopes", null, 0, -1,
				SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSecurityScheme_Settings(), this.getSecuritySchemeParameter(), null, "settings", null, 0, -1,
				SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSecurityScheme_Parameters(), this.getMessageParameter(), null, "parameters", null, 0, -1,
				SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSecurityScheme_ErrorResponses(), this.getTypedResponse(), null, "errorResponses", null, 0, -1,
				SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSecurityScheme_Flow(), this.getAuthenticationFlows(), "flow", null, 0, 1,
				SecurityScheme.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(authenticationMethodEClass, AuthenticationMethod.class, "AuthenticationMethod", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAuthenticationMethod_Scheme(), this.getSecurityScheme(), null, "scheme", null, 1, 1,
				AuthenticationMethod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAuthenticationMethod_Scopes(), this.getSecurityScope(), null, "scopes", null, 0, -1,
				AuthenticationMethod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(securityScopeEClass, SecurityScope.class, "SecurityScope", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSecurityScope_Name(), ecorePackage.getEString(), "name", null, 0, 1, SecurityScope.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(securitySchemeParameterEClass, SecuritySchemeParameter.class, "SecuritySchemeParameter",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSecuritySchemeParameter_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				SecuritySchemeParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSecuritySchemeParameter_Value(), ecorePackage.getEString(), "value", null, 0, 1,
				SecuritySchemeParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(securitySchemeLibraryEClass, SecuritySchemeLibrary.class, "SecuritySchemeLibrary", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSecuritySchemeLibrary_SecuritySchemes(), this.getSecurityScheme(), null, "securitySchemes",
				null, 0, -1, SecuritySchemeLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSecuritySchemeLibrary_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				SecuritySchemeLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(realizationContainerEClass, RealizationContainer.class, "RealizationContainer", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRealizationContainer_WithDefaultRealization(), ecorePackage.getEBoolean(),
				"withDefaultRealization", null, 0, 1, RealizationContainer.class, IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealizationContainer_InlineObjectRealization(), this.getObjectRealization(),
				this.getObjectRealization_RealizationContainer(), "inlineObjectRealization", null, 0, 1,
				RealizationContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealizationContainer_Properties(), this.getObjectRealization(), null, "properties", null, 0,
				1, RealizationContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealizationContainer_ReferenceTreatments(), this.getReferenceTreatment(), null,
				"referenceTreatments", null, 0, -1, RealizationContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRealizationContainer_DataType(), this.getStructure(), null, "dataType", null, 0, 1,
				RealizationContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRealizationContainer_RealizationName(), ecorePackage.getEString(), "realizationName", null, 0,
				1, RealizationContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRealizationContainer_EffectiveRealization(), this.getEffectiveRealization(),
				"effectiveRealization", null, 0, 1, RealizationContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(realizationContainerEClass, this.getStructure(), "getActualType", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(extensibleEClass, Extensible.class, "Extensible", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExtensible_Extensions(), this.getExtension(), null, "extensions", null, 0, -1,
				Extensible.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getExtension_Name(), ecorePackage.getEString(), "name", null, 0, 1, Extension.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtension_Value(), ecorePackage.getEString(), "value", null, 0, 1, Extension.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(realizationModelLocationEClass, RealizationModelLocation.class, "RealizationModelLocation",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRealizationModelLocation_Uri(), ecorePackage.getEString(), "uri", null, 0, 1,
				RealizationModelLocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(realizationModelLocationEClass, this.getRealizationModel(), "getRealizationModel", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		initEClass(hasTitleEClass, HasTitle.class, "HasTitle", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHasTitle_Title(), ecorePackage.getEString(), "title", null, 0, 1, HasTitle.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeature_Name(), ecorePackage.getEString(), "name", null, 0, 1, Feature.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeature_ContainingDataType(), this.getStructure(), this.getStructure_OwnedFeatures(),
				"containingDataType", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_Restriction(), ecorePackage.getEBoolean(), "restriction", null, 0, 1, Feature.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_ReadOnly(), ecorePackage.getEBoolean(), "readOnly", null, 0, 1, Feature.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_Key(), ecorePackage.getEBoolean(), "key", null, 0, 1, Feature.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(referencePropertyEClass, ReferenceProperty.class, "ReferenceProperty", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceProperty_Type(), this.getStructure(), null, "type", null, 1, 1,
				ReferenceProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReferenceProperty_Inverse(), this.getReferenceProperty(), null, "inverse", null, 0, 1,
				ReferenceProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceProperty_Containment(), ecorePackage.getEBoolean(), "containment", null, 0, 1,
				ReferenceProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getReferenceProperty_Container(), ecorePackage.getEBoolean(), "container", null, 0, 1,
				ReferenceProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(primitivePropertyEClass, PrimitiveProperty.class, "PrimitiveProperty", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrimitiveProperty_Type(), this.getSingleValueType(), null, "type", null, 1, 1,
				PrimitiveProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(primitivePropertyEClass, this.getPrimitiveType(), "getPrimitiveType", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(structureEClass, Structure.class, "Structure", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStructure_OwnedFeatures(), this.getFeature(), this.getFeature_ContainingDataType(),
				"ownedFeatures", null, 0, -1, Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStructure_OwnedElements(), this.getStructure(), null, "ownedElements", null, 0, -1,
				Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStructure_OwnedOperations(), this.getOperation(), null, "ownedOperations", null, 0, -1,
				Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStructure_Supertypes(), this.getInheritable(), null, "supertypes", null, 0, -1,
				Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStructure_AllSupertypes(), this.getInheritable(), null, "allSupertypes", null, 0, -1,
				Structure.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		addEOperation(structureEClass, this.getReferenceProperty(), "getReferenceProperties", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(structureEClass, this.getPrimitiveProperty(), "getPrimitiveProperties", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(structureEClass, this.getPrimitiveProperty(), "getAllPrimitiveProperties", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(dataModelEClass, DataModel.class, "DataModel", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataModel_OwnedDataTypes(), this.getDataType(), null, "ownedDataTypes", null, 0, -1,
				DataModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, DataModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(withDataExamplesEClass, WithDataExamples.class, "WithDataExamples", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWithDataExamples_DataExamples(), this.getDataExample(), null, "dataExamples", null, 0, -1,
				WithDataExamples.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dataExampleEClass, DataExample.class, "DataExample", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(inlineDataExampleEClass, InlineDataExample.class, "InlineDataExample", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInlineDataExample_Body(), ecorePackage.getEString(), "body", null, 1, 1,
				InlineDataExample.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(enumerationEClass, Enumeration.class, "Enumeration", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnumeration_EnumConstants(), this.getEnumConstant(), this.getEnumConstant_Enumeration(),
				"enumConstants", null, 0, -1, Enumeration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEnumeration_BaseType(), this.getPrimitiveType(), null, "baseType", null, 1, 1,
		...
		initEClass(enumConstantEClass, EnumConstant.class, "EnumConstant", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEnumConstant_Name(), ecorePackage.getEString(), "name", null, 1, 1, EnumConstant.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnumConstant_IntegerValue(), ecorePackage.getEInt(), "integerValue", null, 0, 1,
				EnumConstant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnumConstant_LiteralValue(), ecorePackage.getEString(), "literalValue", null, 0, 1,
				EnumConstant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getEnumConstant_Enumeration(), this.getEnumeration(), this.getEnumeration_EnumConstants(),
				"enumeration", null, 0, 1, EnumConstant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(enumConstantEClass, ecorePackage.getEInt(), "getImplicitIntegerValue", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(userDefinedTypeEClass, UserDefinedType.class, "UserDefinedType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUserDefinedType_BaseType(), this.getSimpleType(), null, "baseType", null, 1, 1,
				UserDefinedType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(singleValueTypeEClass, SingleValueType.class, "SingleValueType", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		addEOperation(singleValueTypeEClass, this.getPrimitiveType(), "getPrimitiveType", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(elementEClass, Element.class, "Element", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getElement_Cardinality(), this.getCardinality(), "cardinality", null, 0, 1, Element.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(referenceElementEClass, ReferenceElement.class, "ReferenceElement", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReferenceElement_DataType(), this.getStructure(), null, "dataType", null, 0, 1,
				ReferenceElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(referenceElementEClass, ecorePackage.getEString(), "getName", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(lengthConstraintEClass, LengthConstraint.class, "LengthConstraint", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLengthConstraint_MinLength(), ecorePackage.getEInt(), "minLength", null, 0, 1,
				LengthConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLengthConstraint_MaxLength(), ecorePackage.getEInt(), "maxLength", null, 0, 1,
				LengthConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLengthConstraint_Length(), ecorePackage.getEInt(), "length", null, 0, 1,
				LengthConstraint.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				IS_DERIVED, IS_ORDERED);

		initEClass(regExConstraintEClass, RegExConstraint.class, "RegExConstraint", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRegExConstraint_Pattern(), ecorePackage.getEString(), "pattern", null, 0, 1,
				RegExConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(valueRangeConstraintEClass, ValueRangeConstraint.class, "ValueRangeConstraint", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getValueRangeConstraint_MinValue(), ecorePackage.getEString(), "minValue", null, 0, 1,
				ValueRangeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValueRangeConstraint_MinValueExclusive(), ecorePackage.getEBoolean(), "minValueExclusive",
				null, 0, 1, ValueRangeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValueRangeConstraint_MaxValue(), ecorePackage.getEString(), "maxValue", null, 0, 1,
				ValueRangeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValueRangeConstraint_MaxValueExclusive(), ecorePackage.getEBoolean(), "maxValueExclusive",
				null, 0, 1, ValueRangeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constrainableTypeEClass, ConstrainableType.class, "ConstrainableType", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConstrainableType_Constraints(), this.getConstraint(), null, "constraints", null, 0, -1,
				ConstrainableType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(constrainableTypeEClass, this.getConstrainableType(), "getConstrainableParent", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(constrainableTypeEClass, this.getConstraint(), "getAllConstraints", 0, -1, IS_UNIQUE, IS_ORDERED);

		initEClass(inheritableEClass, Inheritable.class, "Inheritable", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(mediaTypesLibraryEClass, MediaTypesLibrary.class, "MediaTypesLibrary", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMediaTypesLibrary_MediaTypes(), this.getMediaType(), null, "mediaTypes", null, 1, -1,
				MediaTypesLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(linkRelationsLibraryEClass, LinkRelationsLibrary.class, "LinkRelationsLibrary", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLinkRelationsLibrary_DefinedLinkRelations(), this.getLinkRelation(), null,
				"definedLinkRelations", null, 0, -1, LinkRelationsLibrary.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkRelationsLibrary_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				LinkRelationsLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(primitiveTypesLibraryEClass, PrimitiveTypesLibrary.class, "PrimitiveTypesLibrary", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPrimitiveTypesLibrary_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				PrimitiveTypesLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrimitiveTypesLibrary_PrimitiveTypes(), this.getPrimitiveType(), null, "primitiveTypes", null,
				0, -1, PrimitiveTypesLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(httpMessageParameterLocationEEnum, HttpMessageParameterLocation.class,
		...
		initEEnum(collectionRealizationLevelEnumEEnum, CollectionRealizationLevelEnum.class,
		...
		initEDataType(realizationModelEDataType, RealizationModel.class, "RealizationModel", !IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(collectionRealizationLevelObjectEDataType, CollectionRealizationLevelEnum.class,
				"CollectionRealizationLevelObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		initEDataType(effectiveRealizationEDataType, EffectiveRealization.class, "EffectiveRealization",
				IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(cardinalityEDataType, int[].class, "Cardinality", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(cardinalityOverrideEDataType, int[].class, "CardinalityOverride", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(collectionRealizationLevelObjectEDataType, source,
				new String[] { "baseType", "CollectionRealizationLevelEnum" });
	}
