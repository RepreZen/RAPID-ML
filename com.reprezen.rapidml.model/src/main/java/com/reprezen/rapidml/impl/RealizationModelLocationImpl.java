 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.RealizationModelLocationImpl#getUri
 * <em>Uri</em>}</li>
 * </ul>
 *
 * @generated
...
public class RealizationModelLocationImpl extends EObjectImpl implements RealizationModelLocation {
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REALIZATION_MODEL_LOCATION__URI,
					oldUri, uri));
	}
		...
		if (realizationModel == null && !failed) {
			...
			if (baseURI != null && Strings.emptyToNull(getUri()) != null) {
				try {
					...
					// TODO
					// RestApiPlugin.logWarning("Cannot load a RealizationModel for " + getUri(),
					// e);
					failed = true;
					return null;
				}
