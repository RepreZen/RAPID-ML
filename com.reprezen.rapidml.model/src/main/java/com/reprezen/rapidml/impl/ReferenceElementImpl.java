 ...
 * '<em><b>Reference Element</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ReferenceElementImpl#getDataType
 * <em>Data Type</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class ReferenceElementImpl extends ElementImpl implements ReferenceElement {
			...
			if (dataType != oldDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.REFERENCE_ELEMENT__DATA_TYPE, oldDataType, dataType));
			}
		}
		return dataType;
	}
	...
	public void setDataType(Structure newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_ELEMENT__DATA_TYPE,
