 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ReferencePropertyImpl#getDataType
 * <em>Data Type</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ReferencePropertyImpl#getType
 * <em>Type</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ReferencePropertyImpl#getInverse
 * <em>Inverse</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ReferencePropertyImpl#isContainment
 * <em>Containment</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.ReferencePropertyImpl#isContainer
 * <em>Container</em>}</li>
 * </ul>
 *
 * @generated
...
public class ReferencePropertyImpl extends FeatureImpl implements ReferenceProperty {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RapidmlPackage.REFERENCE_PROPERTY__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setDataType(Structure newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_PROPERTY__DATA_TYPE,
	...
	public void setType(Structure newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_PROPERTY__TYPE, oldType,
					type));
	}
			...
			if (inverse != oldInverse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.REFERENCE_PROPERTY__INVERSE, oldInverse, inverse));
			}
		}
		return inverse;
	}
	...
	public void setInverse(ReferenceProperty newInverse) {
		...
		inverse = newInverse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_PROPERTY__INVERSE,
					oldInverse, inverse));
	}
	...
	public void setContainment(boolean newContainment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_PROPERTY__CONTAINMENT,
	...
	public void setContainer(boolean newContainer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_PROPERTY__CONTAINER,
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ReferenceElement.class) {
			...
			case RapidmlPackage.REFERENCE_PROPERTY__DATA_TYPE:
				return RapidmlPackage.REFERENCE_ELEMENT__DATA_TYPE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ReferenceElement.class) {
			...
			case RapidmlPackage.REFERENCE_ELEMENT__DATA_TYPE:
				return RapidmlPackage.REFERENCE_PROPERTY__DATA_TYPE;
			default:
				return -1;
			}
		}
