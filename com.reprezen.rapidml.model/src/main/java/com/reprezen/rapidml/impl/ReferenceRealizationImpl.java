 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceRealizationImpl#getTargetResource
 * <em>Target Resource</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceRealizationImpl#getRealizationType
 * <em>Realization Type</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceRealizationImpl#isMultiValued
 * <em>Multi Valued</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceRealizationImpl extends RealizationContainerImpl implements ReferenceRealization {
	/**
	 * The cached value of the '{@link #getTargetResource() <em>Target
	...
	/**
	 * The default value of the '{@link #getRealizationType() <em>Realization
	...
	/**
	 * The cached value of the '{@link #getRealizationType() <em>Realization
	 * Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRealizationType()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isMultiValued() <em>Multi Valued</em>}'
	...
	/**
	 * The cached value of the '{@link #isMultiValued() <em>Multi Valued</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isMultiValued()
	 * @generated
	...
	public Structure getDataType() {
		...
		if (eContainer() instanceof ReferenceTreatment
				&& ((ReferenceTreatment) eContainer()).getReferenceElement() != null) {
			...
			if (targetResource != oldTargetResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.REFERENCE_REALIZATION__TARGET_RESOURCE, oldTargetResource, targetResource));
			}
		}
	...
	public void setTargetResource(ResourceDefinition newTargetResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_REALIZATION__TARGET_RESOURCE,
					oldTargetResource, targetResource));
	}
	...
	public void setRealizationType(ReferenceRealizationEnum newRealizationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.REFERENCE_REALIZATION__REALIZATION_TYPE, oldRealizationType, realizationType));
	}
	...
	public void setMultiValued(boolean newMultiValued) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_REALIZATION__MULTI_VALUED,
					oldMultiValued, multiValued));
	}
