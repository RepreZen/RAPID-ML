 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceTreatmentImpl#getExtensions
 * <em>Extensions</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceTreatmentImpl#getReferenceElement
 * <em>Reference Element</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceTreatmentImpl#getReferenceRealization
 * <em>Reference Realization</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ReferenceTreatmentImpl#getOwnedReferenceRealization
...
public class ReferenceTreatmentImpl extends EObjectImpl implements ReferenceTreatment {
	...
	/**
	 * The cached value of the '{@link #getReferenceRealization() <em>Reference
	 * Realization</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getOwnedReferenceRealization() <em>Owned
	 * Reference Realization</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	public EList<Extension> getExtensions() {
		if (extensions == null) {
			extensions = new EObjectContainmentEList<Extension>(Extension.class, this,
					RapidmlPackage.REFERENCE_TREATMENT__EXTENSIONS);
		}
		return extensions;
	}
			...
			if (referenceElement != oldReferenceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.REFERENCE_TREATMENT__REFERENCE_ELEMENT, oldReferenceElement,
							referenceElement));
			}
		}
	...
	public void setReferenceElement(com.reprezen.rapidml.ReferenceElement newReferenceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.REFERENCE_TREATMENT__REFERENCE_ELEMENT,
	...
	public ReferenceRealization getReferenceRealizationGen() {
		if (referenceRealization != null && referenceRealization.eIsProxy()) {
			...
			if (referenceRealization != oldReferenceRealization) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.REFERENCE_TREATMENT__REFERENCE_REALIZATION, oldReferenceRealization,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwnedReferenceRealization(ReferenceRealization newOwnedReferenceRealization,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, oldOwnedReferenceRealization,
					newOwnedReferenceRealization);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwnedReferenceRealization(ReferenceRealization newOwnedReferenceRealization) {
		if (newOwnedReferenceRealization != ownedReferenceRealization) {
			...
			if (ownedReferenceRealization != null)
				msgs = ((InternalEObject) ownedReferenceRealization).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RapidmlPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, null,
						msgs);
			if (newOwnedReferenceRealization != null)
				msgs = ((InternalEObject) newOwnedReferenceRealization).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - RapidmlPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.REFERENCE_TREATMENT__OWNED_REFERENCE_REALIZATION, newOwnedReferenceRealization,
					newOwnedReferenceRealization));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case RapidmlPackage.REFERENCE_TREATMENT__REFERENCE_REALIZATION:
			if (resolve)
				return getReferenceRealization();
