 ...
 * '<em><b>Resource API</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getSecuredBy <em>Secured
 * By</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getTitle
 * <em>Title</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getVersion
 * <em>Version</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getBaseURI <em>Base
 * URI</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getOwnedResourceDefinitions
 * <em>Owned Resource Definitions</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getServiceDataModels
 * <em>Service Data Models</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getFormats
 * <em>Formats</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getDefinedMediaTypes
 * <em>Defined Media Types</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getDefinedLinkRelations
 * <em>Defined Link Relations</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getDefaultReferenceRealizations
 * <em>Default Reference Realizations</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceAPIImpl#getAutoRealizations
 * <em>Auto Realizations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceAPIImpl extends RESTElementImpl implements ResourceAPI {
	...
	/**
	 * The cached value of the '{@link #getOwnedResourceDefinitions() <em>Owned
	 * Resource Definitions</em>}' containment reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getServiceDataModels() <em>Service Data
	 * Models</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getFormats() <em>Formats</em>}' reference
	...
	/**
	 * The cached value of the '{@link #getDefinedMediaTypes() <em>Defined Media
	...
	/**
	 * The cached value of the '{@link #getDefaultReferenceRealizations()
	 * <em>Default Reference Realizations</em>}' containment reference list. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getAutoRealizations() <em>Auto
	 * Realizations</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	public EList<AuthenticationMethod> getSecuredBy() {
		if (securedBy == null) {
			securedBy = new EObjectContainmentEList<AuthenticationMethod>(AuthenticationMethod.class, this,
					RapidmlPackage.RESOURCE_API__SECURED_BY);
		}
		return securedBy;
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.RESOURCE_API__VERSION, oldVersion,
					version));
	}
	...
	public void setBaseURI(String newBaseURI) {
		...
		baseURI = newBaseURI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.RESOURCE_API__BASE_URI, oldBaseURI,
					baseURI));
	}
	...
	public EList<ResourceDefinition> getOwnedResourceDefinitions() {
		if (ownedResourceDefinitions == null) {
			ownedResourceDefinitions = new EObjectContainmentEList<ResourceDefinition>(ResourceDefinition.class, this,
					RapidmlPackage.RESOURCE_API__OWNED_RESOURCE_DEFINITIONS);
		}
	...
	public EList<com.reprezen.rapidml.DataModel> getServiceDataModels() {
		if (serviceDataModels == null) {
			serviceDataModels = new EObjectResolvingEList<com.reprezen.rapidml.DataModel>(
					com.reprezen.rapidml.DataModel.class, this, RapidmlPackage.RESOURCE_API__SERVICE_DATA_MODELS);
		}
	...
	public EList<MediaType> getDefinedMediaTypes() {
		if (definedMediaTypes == null) {
			definedMediaTypes = new EObjectContainmentEList<MediaType>(MediaType.class, this,
					RapidmlPackage.RESOURCE_API__DEFINED_MEDIA_TYPES);
		}
	...
	public EList<LinkRelation> getDefinedLinkRelations() {
		if (definedLinkRelations == null) {
			definedLinkRelations = new EObjectContainmentEList<LinkRelation>(LinkRelation.class, this,
					RapidmlPackage.RESOURCE_API__DEFINED_LINK_RELATIONS);
		}
	...
	public EList<ReferenceRealization> getDefaultReferenceRealizations() {
		if (defaultReferenceRealizations == null) {
			defaultReferenceRealizations = new EObjectContainmentEList<ReferenceRealization>(ReferenceRealization.class,
					this, RapidmlPackage.RESOURCE_API__DEFAULT_REFERENCE_REALIZATIONS);
		}
	...
	public EList<RealizationModelLocation> getAutoRealizations() {
		if (autoRealizations == null) {
			autoRealizations = new EObjectContainmentEList<RealizationModelLocation>(RealizationModelLocation.class,
					this, RapidmlPackage.RESOURCE_API__AUTO_REALIZATIONS);
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HasSecurityValue.class) {
			...
			case RapidmlPackage.HAS_SECURITY_VALUE__SECURED_BY:
				return RapidmlPackage.RESOURCE_API__SECURED_BY;
			default:
				return -1;
			}
		}
		if (baseClass == HasTitle.class) {
			...
			case RapidmlPackage.HAS_TITLE__TITLE:
				return RapidmlPackage.RESOURCE_API__TITLE;
			default:
				return -1;
			}
		}
