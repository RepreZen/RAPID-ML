 ...
 * '<em><b>Resource Definition</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getExamples
 * <em>Examples</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getSecuredBy
 * <em>Secured By</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getMethods
 * <em>Methods</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getMediaTypes
 * <em>Media Types</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getAllMediaTypes
 * <em>All Media Types</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.ResourceDefinitionImpl#getURI
 * <em>URI</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class ResourceDefinitionImpl extends RESTElementImpl implements ResourceDefinition {
	...
	public EList<Example> getExamples() {
		if (examples == null) {
			examples = new EObjectContainmentEList<Example>(Example.class, this,
					RapidmlPackage.RESOURCE_DEFINITION__EXAMPLES);
		}
		return examples;
	}
	...
	public EList<AuthenticationMethod> getSecuredBy() {
		if (securedBy == null) {
			securedBy = new EObjectContainmentEList<AuthenticationMethod>(AuthenticationMethod.class, this,
					RapidmlPackage.RESOURCE_DEFINITION__SECURED_BY);
		}
		return securedBy;
	}
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentWithInverseEList<Method>(Method.class, this,
					RapidmlPackage.RESOURCE_DEFINITION__METHODS, RapidmlPackage.METHOD__CONTAINING_RESOURCE_DEFINITION);
		}
		return methods;
	}
	...
	public EList<MediaType> getMediaTypes() {
		if (mediaTypes == null) {
			mediaTypes = new EObjectResolvingEList<MediaType>(MediaType.class, this,
					RapidmlPackage.RESOURCE_DEFINITION__MEDIA_TYPES);
		}
		return mediaTypes;
	}
	...
	public NotificationChain basicSetURI(URI newURI, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.RESOURCE_DEFINITION__URI, oldURI, newURI);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newURI != uri) {
			...
			if (uri != null)
				msgs = ((InternalEObject) uri).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RapidmlPackage.RESOURCE_DEFINITION__URI, null, msgs);
			if (newURI != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.RESOURCE_DEFINITION__URI, newURI,
					newURI));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.RESOURCE_DEFINITION__NAME, oldName,
					name));
	}
	...
	public EList<MediaType> getAllMediaTypes() {
		if (allMediaTypes == null) {
			allMediaTypes = new EObjectResolvingEList<MediaType>(MediaType.class, this,
					RapidmlPackage.RESOURCE_DEFINITION__ALL_MEDIA_TYPES);
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WithExamples.class) {
			...
			case RapidmlPackage.WITH_EXAMPLES__EXAMPLES:
				return RapidmlPackage.RESOURCE_DEFINITION__EXAMPLES;
			default:
				return -1;
			}
		}
		if (baseClass == HasSecurityValue.class) {
			...
			case RapidmlPackage.HAS_SECURITY_VALUE__SECURED_BY:
				return RapidmlPackage.RESOURCE_DEFINITION__SECURED_BY;
			default:
				return -1;
			}
		}
