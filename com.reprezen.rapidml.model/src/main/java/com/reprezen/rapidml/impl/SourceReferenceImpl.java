 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.SourceReferenceImpl#getContainingParameter
...
public abstract class SourceReferenceImpl extends EObjectImpl implements SourceReference {
	...
	public Parameter getContainingParameter() {
		if (eContainerFeatureID() != RapidmlPackage.SOURCE_REFERENCE__CONTAINING_PARAMETER)
			return null;
	...
	public NotificationChain basicSetContainingParameter(Parameter newContainingParameter, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingParameter,
				RapidmlPackage.SOURCE_REFERENCE__CONTAINING_PARAMETER, msgs);
		return msgs;
	}
	...
	public void setContainingParameter(Parameter newContainingParameter) {
		if (newContainingParameter != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.SOURCE_REFERENCE__CONTAINING_PARAMETER
						&& newContainingParameter != null)) {
			...
			if (newContainingParameter != null)
				msgs = ((InternalEObject) newContainingParameter).eInverseAdd(this,
						RapidmlPackage.PARAMETER__SOURCE_REFERENCE, Parameter.class, msgs);
			msgs = basicSetContainingParameter(newContainingParameter, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.SOURCE_REFERENCE__CONTAINING_PARAMETER,
					newContainingParameter, newContainingParameter));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case RapidmlPackage.SOURCE_REFERENCE__CONTAINING_PARAMETER:
			return eInternalContainer().eInverseRemove(this, RapidmlPackage.PARAMETER__SOURCE_REFERENCE,
