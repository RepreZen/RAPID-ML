 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getDataExamples
 * <em>Data Examples</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getOwnedFeatures
 * <em>Owned Features</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getOwnedElements
 * <em>Owned Elements</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getOwnedOperations
 * <em>Owned Operations</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getSupertypes
 * <em>Supertypes</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getAllSupertypes
 * <em>All Supertypes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureImpl extends DataTypeImpl implements Structure {
	...
	/**
	 * The cached value of the '{@link #getDataExamples() <em>Data Examples</em>}'
	...
	/**
	 * The cached value of the '{@link #getOwnedFeatures() <em>Owned Features</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getOwnedElements() <em>Owned Elements</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EList<DataExample> getDataExamples() {
		if (dataExamples == null) {
			dataExamples = new EObjectContainmentEList<DataExample>(DataExample.class, this,
					RapidmlPackage.STRUCTURE__DATA_EXAMPLES);
		}
		return dataExamples;
	}
	...
	public EList<Feature> getOwnedFeatures() {
		if (ownedFeatures == null) {
			ownedFeatures = new EObjectContainmentWithInverseEList<Feature>(Feature.class, this,
					RapidmlPackage.STRUCTURE__OWNED_FEATURES, RapidmlPackage.FEATURE__CONTAINING_DATA_TYPE);
		}
	...
	public EList<Structure> getOwnedElements() {
		if (ownedElements == null) {
			ownedElements = new EObjectContainmentEList<Structure>(Structure.class, this,
					RapidmlPackage.STRUCTURE__OWNED_ELEMENTS);
		}
	...
	public EList<Operation> getOwnedOperations() {
		if (ownedOperations == null) {
			ownedOperations = new EObjectContainmentEList<Operation>(Operation.class, this,
					RapidmlPackage.STRUCTURE__OWNED_OPERATIONS);
		}
	...
	public EList<Inheritable> getSupertypes() {
		if (supertypes == null) {
			supertypes = new EObjectResolvingEList<Inheritable>(Inheritable.class, this,
					RapidmlPackage.STRUCTURE__SUPERTYPES);
		}
		return supertypes;
	}
	...
	public EList<Inheritable> getAllSupertypes() {
		...
		// We need an org.eclipse.emf.ecore.util.InternalEList for proper Eclipse rename
		// refactoring
		// Apparently InternalEList is expected for multi-valued features, see
		// https://www.eclipse.org/forums/index.php/t/130207/
		return new EcoreEList.UnmodifiableEList.FastCompare<Inheritable>(this,
				RapidmlPackage.eINSTANCE.getStructure_AllSupertypes(), allSupertypes.size(), allSupertypes.toArray());
	}
	...
	public EList<ReferenceProperty> getReferenceProperties() {
		Collection<ReferenceProperty> referenceProperties = com.google.common.collect.Lists
				.newArrayList(com.google.common.collect.Iterables.filter(getOwnedFeatures(),
						com.reprezen.rapidml.ReferenceProperty.class));
	...
	public EList<PrimitiveProperty> getPrimitiveProperties() {
		Collection<PrimitiveProperty> primitiveProperties = com.google.common.collect.Lists
				.newArrayList(com.google.common.collect.Iterables.filter(getOwnedFeatures(),
						com.reprezen.rapidml.PrimitiveProperty.class));
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WithDataExamples.class) {
			...
			case RapidmlPackage.STRUCTURE__DATA_EXAMPLES:
				return RapidmlPackage.WITH_DATA_EXAMPLES__DATA_EXAMPLES;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WithDataExamples.class) {
			...
			case RapidmlPackage.WITH_DATA_EXAMPLES__DATA_EXAMPLES:
				return RapidmlPackage.STRUCTURE__DATA_EXAMPLES;
			default:
				return -1;
			}
		}
