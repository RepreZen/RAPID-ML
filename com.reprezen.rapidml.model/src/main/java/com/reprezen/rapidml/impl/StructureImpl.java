 ...
 * </p>
 * <ul>
 *   <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getDataExamples <em>Data Examples</em>}</li>
 *   <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getOwnedFeatures <em>Owned Features</em>}</li>
 *   <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getOwnedOperations <em>Owned Operations</em>}</li>
 *   <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getSupertypes <em>Supertypes</em>}</li>
 *   <li>{@link com.reprezen.rapidml.datatypes.impl.StructureImpl#getAllSupertypes <em>All Supertypes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureImpl extends DataTypeImpl implements Structure {
    ...
    public EList<ReferenceProperty> getReferenceProperties() {
        Collection<ReferenceProperty> referenceProperties = com.google.common.collect.Lists.newArrayList(com.google.common.collect.Iterables.filter(getOwnedFeatures(), com.reprezen.rapidml.ReferenceProperty.class));
    ...
    public EList<PrimitiveProperty> getPrimitiveProperties() {
        Collection<PrimitiveProperty> primitiveProperties = com.google.common.collect.Lists.newArrayList(com.google.common.collect.Iterables.filter(getOwnedFeatures(), com.reprezen.rapidml.PrimitiveProperty.class));
