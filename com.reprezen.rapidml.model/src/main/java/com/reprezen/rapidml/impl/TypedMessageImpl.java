 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.TypedMessageImpl#getDocumentation
 * <em>Documentation</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.TypedMessageImpl#getExamples
 * <em>Examples</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.TypedMessageImpl#getParameters
 * <em>Parameters</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.TypedMessageImpl#getResourceType
 * <em>Resource Type</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.TypedMessageImpl#isUseParentTypeReference
 * <em>Use Parent Type Reference</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.TypedMessageImpl#getMediaTypes <em>Media
 * Types</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class TypedMessageImpl extends RealizationContainerImpl implements TypedMessage {
	...
	/**
	 * The cached value of the '{@link #getResourceType() <em>Resource Type</em>}'
	...
	/**
	 * The default value of the '{@link #isUseParentTypeReference() <em>Use Parent
	 * Type Reference</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isUseParentTypeReference() <em>Use Parent
	 * Type Reference</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see #isUseParentTypeReference()
	...
	public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.TYPED_MESSAGE__DOCUMENTATION, oldDocumentation, newDocumentation);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject) documentation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RapidmlPackage.TYPED_MESSAGE__DOCUMENTATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.TYPED_MESSAGE__DOCUMENTATION,
	...
	public EList<Example> getExamples() {
		if (examples == null) {
			examples = new EObjectContainmentEList<Example>(Example.class, this,
					RapidmlPackage.TYPED_MESSAGE__EXAMPLES);
		}
		return examples;
	}
	...
	public EList<MessageParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<MessageParameter>(MessageParameter.class, this,
					RapidmlPackage.TYPED_MESSAGE__PARAMETERS, RapidmlPackage.MESSAGE_PARAMETER__CONTAINING_MESSAGE);
		}
		return parameters;
	}
			...
			if (resourceType != oldResourceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.TYPED_MESSAGE__RESOURCE_TYPE, oldResourceType, resourceType));
			}
		}
		return resourceType;
	}
	...
	public void setResourceType(ResourceDefinition newResourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.TYPED_MESSAGE__RESOURCE_TYPE,
	...
	public void setUseParentTypeReference(boolean newUseParentTypeReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RapidmlPackage.TYPED_MESSAGE__USE_PARENT_TYPE_REFERENCE, oldUseParentTypeReference,
	...
	public EList<MediaType> getMediaTypes() {
		if (mediaTypes == null) {
			mediaTypes = new EObjectResolvingEList<MediaType>(MediaType.class, this,
					RapidmlPackage.TYPED_MESSAGE__MEDIA_TYPES);
		}
		return mediaTypes;
	}
	...
	public EList<ReferenceLink> getReferenceLinks() {
		Collection<ReferenceLink> referenceTreatments = com.google.common.collect.Lists.newArrayList(
				com.google.common.collect.Iterables.filter(getReferenceTreatments(), ReferenceLink.class));
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Documentable.class) {
			...
			case RapidmlPackage.DOCUMENTABLE__DOCUMENTATION:
				return RapidmlPackage.TYPED_MESSAGE__DOCUMENTATION;
			default:
				return -1;
			}
		}
		...
		if (baseClass == WithExamples.class) {
			...
			case RapidmlPackage.WITH_EXAMPLES__EXAMPLES:
				return RapidmlPackage.TYPED_MESSAGE__EXAMPLES;
			default:
				return -1;
			}
		}
