 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.TypedRequestImpl#getContainingMethod
...
public class TypedRequestImpl extends TypedMessageImpl implements TypedRequest {
	...
	public Method getContainingMethod() {
		if (eContainerFeatureID() != RapidmlPackage.TYPED_REQUEST__CONTAINING_METHOD)
			return null;
	...
	public NotificationChain basicSetContainingMethod(Method newContainingMethod, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingMethod,
				RapidmlPackage.TYPED_REQUEST__CONTAINING_METHOD, msgs);
		return msgs;
	}
	...
	public void setContainingMethod(Method newContainingMethod) {
		if (newContainingMethod != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.TYPED_REQUEST__CONTAINING_METHOD
			...
			if (newContainingMethod != null)
				msgs = ((InternalEObject) newContainingMethod).eInverseAdd(this, RapidmlPackage.METHOD__REQUEST,
						Method.class, msgs);
			msgs = basicSetContainingMethod(newContainingMethod, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.TYPED_REQUEST__CONTAINING_METHOD,
