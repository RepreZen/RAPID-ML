 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.impl.TypedResponseImpl#getStatusCode
 * <em>Status Code</em>}</li>
 * <li>{@link com.reprezen.rapidml.impl.TypedResponseImpl#getContainingMethod
...
public class TypedResponseImpl extends TypedMessageImpl implements TypedResponse {
	...
	public void setStatusCode(int newStatusCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.TYPED_RESPONSE__STATUS_CODE,
	...
	public Method getContainingMethod() {
		if (eContainerFeatureID() != RapidmlPackage.TYPED_RESPONSE__CONTAINING_METHOD)
			return null;
	...
	public NotificationChain basicSetContainingMethod(Method newContainingMethod, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingMethod,
				RapidmlPackage.TYPED_RESPONSE__CONTAINING_METHOD, msgs);
		return msgs;
	}
	...
	public void setContainingMethod(Method newContainingMethod) {
		if (newContainingMethod != eInternalContainer()
				|| (eContainerFeatureID() != RapidmlPackage.TYPED_RESPONSE__CONTAINING_METHOD
						&& newContainingMethod != null)) {
			...
			if (newContainingMethod != null)
				msgs = ((InternalEObject) newContainingMethod).eInverseAdd(this, RapidmlPackage.METHOD__RESPONSES,
						Method.class, msgs);
			msgs = basicSetContainingMethod(newContainingMethod, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.TYPED_RESPONSE__CONTAINING_METHOD,
					newContainingMethod, newContainingMethod));
	}
