 ...
 * </p>
 * <ul>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.UserDefinedTypeImpl#getConstraints
 * <em>Constraints</em>}</li>
 * <li>{@link com.reprezen.rapidml.datatypes.impl.UserDefinedTypeImpl#getBaseType
 * <em>Base Type</em>}</li>
 * </ul>
 *
 * @generated
...
public class UserDefinedTypeImpl extends SimpleTypeImpl implements UserDefinedType {
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this,
					RapidmlPackage.USER_DEFINED_TYPE__CONSTRAINTS);
		}
		return constraints;
	}
			...
			if (baseType != oldBaseType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RapidmlPackage.USER_DEFINED_TYPE__BASE_TYPE, oldBaseType, baseType));
			}
		}
		return baseType;
	}
	...
	public void setBaseType(SimpleType newBaseType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RapidmlPackage.USER_DEFINED_TYPE__BASE_TYPE,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ConstrainableType.class) {
			...
			case RapidmlPackage.CONSTRAINABLE_TYPE__CONSTRAINTS:
				return RapidmlPackage.USER_DEFINED_TYPE__CONSTRAINTS;
			default:
				return -1;
			}
		}
