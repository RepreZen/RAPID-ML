...
public class EcoreUtil2 {
	private static org.eclipse.emf.common.util.URI getResolvedImportUri(Resource context,
	...
	public static Resource getResource(Resource context, String uri) {
		org.eclipse.emf.common.util.URI newURI = getResolvedImportUri(context,
