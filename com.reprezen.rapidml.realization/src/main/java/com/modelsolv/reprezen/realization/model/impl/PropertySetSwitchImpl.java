...
import com.modelsolv.reprezen.realization.model.impl.ConditionalPropertySetImpl;
...
public class PropertySetSwitchImpl extends PropertySetImpl implements PropertySetSwitch {
    ...
    public static OverlayFactory<PropertySetSwitch> factory = new OverlayFactory<PropertySetSwitch>() {
        ...
        @Override
        public JsonOverlay<PropertySetSwitch> _create(PropertySetSwitch propertySetSwitch, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
            overlay = new PropertySetSwitchImpl(propertySetSwitch, parent, refMgr);
            @SuppressWarnings("unchecked") JsonOverlay<PropertySetSwitch> castOverlay = (JsonOverlay<PropertySetSwitch>) overlay;
            return castOverlay;
        }
