 ...
 *******************************************************************************/
package com.modelsolv.reprezen.realization.parser;
...
import com.modelsolv.reprezen.realization.model.impl.RealizationModelImpl;
...
public class RealizationModelParser {
    ...
    private void createValidator() {
        if (validator == null) {
            ...
            try {
                schemaUrl = new URL(
                        "platform:/plugin/com.modelsolv.reprezen.realization/schema/auto-realization-config-schema.json");
