        ...
        public JsonOverlay<Base> _create(Base base, JsonOverlay<?> parent, ReferenceManager refMgr) {
            ...
            switch(subtype != null ? subtype.getSimpleName() : "") {
                ...
                case "PrimitivePropertySelector":
                    overlay = PrimitivePropertySelectorImpl.factory.create((PrimitivePropertySelector) base, parent, refMgr);
                    break;
                ...
                case "ObjectRealizationStrategy":
                    overlay = ObjectRealizationStrategyImpl.factory.create((ObjectRealizationStrategy) base, parent, refMgr);
                    break;
                ...
                case "ResourceDefinitionContext":
                    overlay = ResourceDefinitionContextImpl.factory.create((ResourceDefinitionContext) base, parent, refMgr);
                    break;
                case "ReferencePropertyRealization":
                    overlay = ReferencePropertyRealizationImpl.factory.create((ReferencePropertyRealization) base, parent, refMgr);
                    break;
                case "ContextPattern":
                    overlay = ContextPatternImpl.factory.create((ContextPattern) base, parent, refMgr);
                    break;
                case "PrimitivePropertyRealization":
                    overlay = PrimitivePropertyRealizationImpl.factory.create((PrimitivePropertyRealization) base, parent, refMgr);
                    break;
                ...
                case "ReferencePropertySelector":
                    overlay = ReferencePropertySelectorImpl.factory.create((ReferencePropertySelector) base, parent, refMgr);
                    break;
            ...
            @SuppressWarnings("unchecked") JsonOverlay<Base> castOverlay = (JsonOverlay<Base>) overlay;
            return castOverlay;
        }
