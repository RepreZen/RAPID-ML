...
public class ConditionalPropertySetImpl extends PropertySetImpl implements ConditionalPropertySet {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ConditionalPropertySetImpl(ConditionalPropertySet conditionalPropertySet, JsonOverlay<?> parent,
	...
	public static OverlayFactory<ConditionalPropertySet> factory = new OverlayFactory<ConditionalPropertySet>() {
		...
		@Override
		public JsonOverlay<ConditionalPropertySet> _create(ConditionalPropertySet conditionalPropertySet,
			...
			JsonOverlay<ConditionalPropertySet> castOverlay = (JsonOverlay<ConditionalPropertySet>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<ConditionalPropertySet> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
