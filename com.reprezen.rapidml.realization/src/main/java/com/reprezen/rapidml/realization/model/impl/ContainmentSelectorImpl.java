...
public class ContainmentSelectorImpl extends EnumOverlay<ContainmentSelector> {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ContainmentSelectorImpl(ContainmentSelector containmentSelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<ContainmentSelector> factory = new OverlayFactory<ContainmentSelector>() {
		...
		@Override
		public JsonOverlay<ContainmentSelector> _create(ContainmentSelector containmentSelector, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
