...
public class DefinitionContextImpl extends BaseImpl implements DefinitionContext {
	...
	public static OverlayFactory<DefinitionContext> factory = new OverlayFactory<DefinitionContext>() {
		...
		@Override
		public JsonOverlay<DefinitionContext> _create(DefinitionContext definitionContext, JsonOverlay<?> parent,
			...
			case "ResourceDefinitionContext":
				overlay = ResourceDefinitionContextImpl.factory.create((ResourceDefinitionContext) definitionContext,
						parent, refMgr);
				break;
			case "MessageDefinitionContext":
				overlay = MessageDefinitionContextImpl.factory.create((MessageDefinitionContext) definitionContext,
						parent, refMgr);
				break;
			default:
			...
			JsonOverlay<DefinitionContext> castOverlay = (JsonOverlay<DefinitionContext>) overlay;
			return castOverlay;
		}
