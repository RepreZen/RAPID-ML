...
public class InclusivePropertySetImpl extends PropertySetImpl implements InclusivePropertySet {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public InclusivePropertySetImpl(InclusivePropertySet inclusivePropertySet, JsonOverlay<?> parent,
	...
	public static OverlayFactory<InclusivePropertySet> factory = new OverlayFactory<InclusivePropertySet>() {
		...
		@Override
		public JsonOverlay<InclusivePropertySet> _create(InclusivePropertySet inclusivePropertySet,
				JsonOverlay<?> parent, ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
			overlay = new InclusivePropertySetImpl(inclusivePropertySet, parent, refMgr);
			@SuppressWarnings("unchecked")
			JsonOverlay<InclusivePropertySet> castOverlay = (JsonOverlay<InclusivePropertySet>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<InclusivePropertySet> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
