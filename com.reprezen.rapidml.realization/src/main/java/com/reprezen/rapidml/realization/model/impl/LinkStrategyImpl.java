...
public class LinkStrategyImpl extends BaseImpl implements LinkStrategy {
	...
	public static OverlayFactory<LinkStrategy> factory = new OverlayFactory<LinkStrategy>() {
		...
		@Override
		public JsonOverlay<LinkStrategy> _create(LinkStrategy linkStrategy, JsonOverlay<?> parent,
			...
			JsonOverlay<LinkStrategy> castOverlay = (JsonOverlay<LinkStrategy>) overlay;
			return castOverlay;
		}
