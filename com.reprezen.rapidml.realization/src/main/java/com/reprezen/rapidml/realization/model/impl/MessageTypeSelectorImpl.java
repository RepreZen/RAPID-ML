...
public class MessageTypeSelectorImpl extends EnumOverlay<MessageTypeSelector> {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public MessageTypeSelectorImpl(MessageTypeSelector messageTypeSelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<MessageTypeSelector> factory = new OverlayFactory<MessageTypeSelector>() {
		...
		@Override
		public JsonOverlay<MessageTypeSelector> _create(MessageTypeSelector messageTypeSelector, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
