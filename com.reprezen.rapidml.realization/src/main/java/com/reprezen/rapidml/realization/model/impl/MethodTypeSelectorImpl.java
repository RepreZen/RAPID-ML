...
public class MethodTypeSelectorImpl extends EnumOverlay<MethodTypeSelector> {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public MethodTypeSelectorImpl(MethodTypeSelector methodTypeSelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<MethodTypeSelector> factory = new OverlayFactory<MethodTypeSelector>() {
		...
		@Override
		public JsonOverlay<MethodTypeSelector> _create(MethodTypeSelector methodTypeSelector, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
