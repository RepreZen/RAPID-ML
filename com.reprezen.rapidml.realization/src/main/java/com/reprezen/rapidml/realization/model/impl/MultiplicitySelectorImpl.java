...
public class MultiplicitySelectorImpl extends EnumOverlay<MultiplicitySelector> {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public MultiplicitySelectorImpl(MultiplicitySelector multiplicitySelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<MultiplicitySelector> factory = new OverlayFactory<MultiplicitySelector>() {
		...
		@Override
		public JsonOverlay<MultiplicitySelector> _create(MultiplicitySelector multiplicitySelector,
				JsonOverlay<?> parent, ReferenceManager refMgr) {
			return new MultiplicitySelectorImpl(multiplicitySelector, parent, refMgr);
		}

		@Override
		public JsonOverlay<MultiplicitySelector> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
