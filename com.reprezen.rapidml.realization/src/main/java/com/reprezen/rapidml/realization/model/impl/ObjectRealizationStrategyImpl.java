...
public class ObjectRealizationStrategyImpl extends BaseImpl implements ObjectRealizationStrategy {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ObjectRealizationStrategyImpl(ObjectRealizationStrategy objectRealizationStrategy, JsonOverlay<?> parent,
	...
	public static OverlayFactory<ObjectRealizationStrategy> factory = new OverlayFactory<ObjectRealizationStrategy>() {
		...
		@Override
		public JsonOverlay<ObjectRealizationStrategy> _create(ObjectRealizationStrategy objectRealizationStrategy,
			...
			case "ObjectRealizationSpec":
				overlay = ObjectRealizationSpecImpl.factory.create((ObjectRealizationSpec) objectRealizationStrategy,
						parent, refMgr);
				break;
			default:
				overlay = new ObjectRealizationStrategyImpl((ObjectRealizationStrategy) objectRealizationStrategy,
						parent, refMgr);
			}
			@SuppressWarnings("unchecked")
			JsonOverlay<ObjectRealizationStrategy> castOverlay = (JsonOverlay<ObjectRealizationStrategy>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<ObjectRealizationStrategy> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	private static Class<? extends ObjectRealizationStrategy> getSubtypeOf(
			ObjectRealizationStrategy objectRealizationStrategy) {
