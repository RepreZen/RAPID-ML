...
public class PrimitivePropertyRealizationImpl extends PropertyTypeRealizationImpl
		implements PrimitivePropertyRealization {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public PrimitivePropertyRealizationImpl(PrimitivePropertyRealization primitivePropertyRealization,
	...
	public static OverlayFactory<PrimitivePropertyRealization> factory = new OverlayFactory<PrimitivePropertyRealization>() {
		...
		@Override
		public JsonOverlay<PrimitivePropertyRealization> _create(
				PrimitivePropertyRealization primitivePropertyRealization, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
			overlay = new PrimitivePropertyRealizationImpl(primitivePropertyRealization, parent, refMgr);
			@SuppressWarnings("unchecked")
			JsonOverlay<PrimitivePropertyRealization> castOverlay = (JsonOverlay<PrimitivePropertyRealization>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<PrimitivePropertyRealization> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	private static Class<? extends PrimitivePropertyRealization> getSubtypeOf(
			PrimitivePropertyRealization primitivePropertyRealization) {
