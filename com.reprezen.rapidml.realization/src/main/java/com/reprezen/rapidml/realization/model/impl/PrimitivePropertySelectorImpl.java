...
public class PrimitivePropertySelectorImpl extends PropertyTypeSelectorImpl implements PrimitivePropertySelector {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public PrimitivePropertySelectorImpl(PrimitivePropertySelector primitivePropertySelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<PrimitivePropertySelector> factory = new OverlayFactory<PrimitivePropertySelector>() {
		...
		@Override
		public JsonOverlay<PrimitivePropertySelector> _create(PrimitivePropertySelector primitivePropertySelector,
			...
			JsonOverlay<PrimitivePropertySelector> castOverlay = (JsonOverlay<PrimitivePropertySelector>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<PrimitivePropertySelector> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	private static Class<? extends PrimitivePropertySelector> getSubtypeOf(
			PrimitivePropertySelector primitivePropertySelector) {
