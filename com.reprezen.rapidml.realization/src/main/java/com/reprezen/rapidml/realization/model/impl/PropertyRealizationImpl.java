...
public class PropertyRealizationImpl extends AbstractPropertySelectorImpl implements PropertyRealization {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public PropertyRealizationImpl(PropertyRealization propertyRealization, JsonOverlay<?> parent,
	...
	public static OverlayFactory<PropertyRealization> factory = new OverlayFactory<PropertyRealization>() {
		...
		@Override
		public JsonOverlay<PropertyRealization> _create(PropertyRealization propertyRealization, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
			overlay = new PropertyRealizationImpl(propertyRealization, parent, refMgr);
			@SuppressWarnings("unchecked")
			JsonOverlay<PropertyRealization> castOverlay = (JsonOverlay<PropertyRealization>) overlay;
			return castOverlay;
		}
