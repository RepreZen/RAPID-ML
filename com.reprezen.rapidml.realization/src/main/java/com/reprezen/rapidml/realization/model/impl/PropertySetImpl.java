...
public class PropertySetImpl extends BaseImpl implements PropertySet {
	...
	public static OverlayFactory<PropertySet> factory = new OverlayFactory<PropertySet>() {
		...
		@Override
		public JsonOverlay<PropertySet> _create(PropertySet propertySet, JsonOverlay<?> parent,
			...
			case "ConditionalPropertySet":
				overlay = ConditionalPropertySetImpl.factory.create((ConditionalPropertySet) propertySet, parent,
						refMgr);
				break;
			...
			JsonOverlay<PropertySet> castOverlay = (JsonOverlay<PropertySet>) overlay;
			return castOverlay;
		}
