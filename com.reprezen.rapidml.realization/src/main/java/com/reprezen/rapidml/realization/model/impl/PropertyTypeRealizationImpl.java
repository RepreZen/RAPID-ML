...
public class PropertyTypeRealizationImpl extends BaseImpl implements PropertyTypeRealization {
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    public PropertyTypeRealizationImpl(PropertyTypeRealization propertyTypeRealization, JsonOverlay<?> parent, ReferenceManager refMgr) {
    ...
    public static OverlayFactory<PropertyTypeRealization> factory = new OverlayFactory<PropertyTypeRealization>() {
        ...
        @Override
        public JsonOverlay<PropertyTypeRealization> _create(PropertyTypeRealization propertyTypeRealization, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
            ...
            switch(subtype != null ? subtype.getSimpleName() : "") {
                case "ReferencePropertyRealization":
                    overlay = ReferencePropertyRealizationImpl.factory.create((ReferencePropertyRealization) propertyTypeRealization, parent, refMgr);
                    break;
                case "PrimitivePropertyRealization":
                    overlay = PrimitivePropertyRealizationImpl.factory.create((PrimitivePropertyRealization) propertyTypeRealization, parent, refMgr);
                    break;
                default:
                    overlay = new PropertyTypeRealizationImpl((PropertyTypeRealization) propertyTypeRealization, parent, refMgr);
            }
            @SuppressWarnings("unchecked") JsonOverlay<PropertyTypeRealization> castOverlay = (JsonOverlay<PropertyTypeRealization>) overlay;
            return castOverlay;
        }

        @Override
        public JsonOverlay<PropertyTypeRealization> _create(JsonNode json, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    private static Class<? extends PropertyTypeRealization> getSubtypeOf(PropertyTypeRealization propertyTypeRealization) {
