...
public class ReferenceLevelContextImpl extends BaseImpl implements ReferenceLevelContext {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ReferenceLevelContextImpl(ReferenceLevelContext referenceLevelContext, JsonOverlay<?> parent,
	...
	public static OverlayFactory<ReferenceLevelContext> factory = new OverlayFactory<ReferenceLevelContext>() {
		...
		@Override
		public JsonOverlay<ReferenceLevelContext> _create(ReferenceLevelContext referenceLevelContext,
			...
			case "RootObjectContext":
				overlay = RootObjectContextImpl.factory.create((RootObjectContext) referenceLevelContext, parent,
						refMgr);
				break;
			case "ReferencePropertyContext":
				overlay = ReferencePropertyContextImpl.factory.create((ReferencePropertyContext) referenceLevelContext,
						parent, refMgr);
				break;
			default:
			...
			JsonOverlay<ReferenceLevelContext> castOverlay = (JsonOverlay<ReferenceLevelContext>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<ReferenceLevelContext> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
