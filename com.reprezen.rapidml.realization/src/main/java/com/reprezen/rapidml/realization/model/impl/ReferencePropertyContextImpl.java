...
import com.reprezen.rapidml.realization.model.impl.ReadWriteSelectorImpl;
...
import com.reprezen.rapidml.realization.model.impl.MultiplicitySelectorImpl;
...
public class ReferencePropertyContextImpl extends ReferenceLevelContextImpl implements ReferencePropertyContext {
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    public ReferencePropertyContextImpl(ReferencePropertyContext referencePropertyContext, JsonOverlay<?> parent, ReferenceManager refMgr) {
    ...
    public static OverlayFactory<ReferencePropertyContext> factory = new OverlayFactory<ReferencePropertyContext>() {
        ...
        @Override
        public JsonOverlay<ReferencePropertyContext> _create(ReferencePropertyContext referencePropertyContext, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
            overlay = new ReferencePropertyContextImpl(referencePropertyContext, parent, refMgr);
            @SuppressWarnings("unchecked") JsonOverlay<ReferencePropertyContext> castOverlay = (JsonOverlay<ReferencePropertyContext>) overlay;
            return castOverlay;
        }

        @Override
        public JsonOverlay<ReferencePropertyContext> _create(JsonNode json, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    private static Class<? extends ReferencePropertyContext> getSubtypeOf(ReferencePropertyContext referencePropertyContext) {
