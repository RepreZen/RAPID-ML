...
public class ReferencePropertyRealizationImpl extends PropertyTypeRealizationImpl
		implements ReferencePropertyRealization {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ReferencePropertyRealizationImpl(ReferencePropertyRealization referencePropertyRealization,
	...
	public static OverlayFactory<ReferencePropertyRealization> factory = new OverlayFactory<ReferencePropertyRealization>() {
		...
		@Override
		public JsonOverlay<ReferencePropertyRealization> _create(
				ReferencePropertyRealization referencePropertyRealization, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
			overlay = new ReferencePropertyRealizationImpl(referencePropertyRealization, parent, refMgr);
			@SuppressWarnings("unchecked")
			JsonOverlay<ReferencePropertyRealization> castOverlay = (JsonOverlay<ReferencePropertyRealization>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<ReferencePropertyRealization> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	private static Class<? extends ReferencePropertyRealization> getSubtypeOf(
			ReferencePropertyRealization referencePropertyRealization) {
