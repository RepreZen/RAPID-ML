...
public class ReferencePropertySelectorImpl extends PropertyTypeSelectorImpl implements ReferencePropertySelector {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ReferencePropertySelectorImpl(ReferencePropertySelector referencePropertySelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<ReferencePropertySelector> factory = new OverlayFactory<ReferencePropertySelector>() {
		...
		@Override
		public JsonOverlay<ReferencePropertySelector> _create(ReferencePropertySelector referencePropertySelector,
			...
			JsonOverlay<ReferencePropertySelector> castOverlay = (JsonOverlay<ReferencePropertySelector>) overlay;
			return castOverlay;
		}

		@Override
		public JsonOverlay<ReferencePropertySelector> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
			JsonOverlay<?> overlay;
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	private static Class<? extends ReferencePropertySelector> getSubtypeOf(
			ReferencePropertySelector referencePropertySelector) {
