...
public class ResourceDefinitionContextImpl extends DefinitionContextImpl implements ResourceDefinitionContext {
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    public ResourceDefinitionContextImpl(ResourceDefinitionContext resourceDefinitionContext, JsonOverlay<?> parent, ReferenceManager refMgr) {
    ...
    public static OverlayFactory<ResourceDefinitionContext> factory = new OverlayFactory<ResourceDefinitionContext>() {
        ...
        @Override
        public JsonOverlay<ResourceDefinitionContext> _create(ResourceDefinitionContext resourceDefinitionContext, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
            overlay = new ResourceDefinitionContextImpl(resourceDefinitionContext, parent, refMgr);
            @SuppressWarnings("unchecked") JsonOverlay<ResourceDefinitionContext> castOverlay = (JsonOverlay<ResourceDefinitionContext>) overlay;
            return castOverlay;
        }

        @Override
        public JsonOverlay<ResourceDefinitionContext> _create(JsonNode json, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    private static Class<? extends ResourceDefinitionContext> getSubtypeOf(ResourceDefinitionContext resourceDefinitionContext) {
