...
public class ResourceTypeSelectorImpl extends EnumOverlay<ResourceTypeSelector> {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public ResourceTypeSelectorImpl(ResourceTypeSelector resourceTypeSelector, JsonOverlay<?> parent,
	...
	public static OverlayFactory<ResourceTypeSelector> factory = new OverlayFactory<ResourceTypeSelector>() {
		...
		@Override
		public JsonOverlay<ResourceTypeSelector> _create(ResourceTypeSelector resourceTypeSelector,
				JsonOverlay<?> parent, ReferenceManager refMgr) {
			return new ResourceTypeSelectorImpl(resourceTypeSelector, parent, refMgr);
		}

		@Override
		public JsonOverlay<ResourceTypeSelector> _create(JsonNode json, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
