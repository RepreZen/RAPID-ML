...
public class TargetResourceTypeImpl extends EnumOverlay<TargetResourceType> {
	...
	@Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
	public TargetResourceTypeImpl(TargetResourceType targetResourceType, JsonOverlay<?> parent,
	...
	public static OverlayFactory<TargetResourceType> factory = new OverlayFactory<TargetResourceType>() {
		...
		@Override
		public JsonOverlay<TargetResourceType> _create(TargetResourceType targetResourceType, JsonOverlay<?> parent,
				ReferenceManager refMgr) {
