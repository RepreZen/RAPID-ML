...
public class PropertyTypeSelectorImpl extends BaseImpl implements PropertyTypeSelector {
    ...
    @Generated("com.reprezen.jsonoverlay.gen.CodeGenerator")
    public PropertyTypeSelectorImpl(PropertyTypeSelector propertyTypeSelector, JsonOverlay<?> parent, ReferenceManager refMgr) {
    ...
    public static OverlayFactory<PropertyTypeSelector> factory = new OverlayFactory<PropertyTypeSelector>() {
        ...
        @Override
        public JsonOverlay<PropertyTypeSelector> _create(PropertyTypeSelector propertyTypeSelector, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
            ...
            switch(subtype != null ? subtype.getSimpleName() : "") {
                case "ReferencePropertySelector":
                    overlay = ReferencePropertySelectorImpl.factory.create((ReferencePropertySelector) propertyTypeSelector, parent, refMgr);
                    break;
                case "PrimitivePropertySelector":
                    overlay = PrimitivePropertySelectorImpl.factory.create((PrimitivePropertySelector) propertyTypeSelector, parent, refMgr);
                    break;
                default:
                    overlay = new PropertyTypeSelectorImpl((PropertyTypeSelector) propertyTypeSelector, parent, refMgr);
            }
            @SuppressWarnings("unchecked") JsonOverlay<PropertyTypeSelector> castOverlay = (JsonOverlay<PropertyTypeSelector>) overlay;
            return castOverlay;
        }

        @Override
        public JsonOverlay<PropertyTypeSelector> _create(JsonNode json, JsonOverlay<?> parent, ReferenceManager refMgr) {
            JsonOverlay<?> overlay;
