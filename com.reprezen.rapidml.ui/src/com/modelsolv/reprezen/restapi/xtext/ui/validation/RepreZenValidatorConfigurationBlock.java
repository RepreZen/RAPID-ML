 ...
 *******************************************************************************/
package com.modelsolv.reprezen.restapi.xtext.ui.validation;
...
import com.modelsolv.reprezen.restapi.xtext.validation.ElementOrderSorter;
...
public class RepreZenValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {
    ...
    private List<EClass> elementWithRandomOrder = Lists.newArrayList(RestapiPackage.Literals.COLLECTION_RESOURCE,
            RestapiPackage.Literals.OBJECT_RESOURCE);
