...
public abstract class EmfUtils {
     ...
     * resolved by the {@link com.modelsolv.reprezen.core.workspace.Workspace}. The URIs that cannot be resolved are the ones in
     * plug-ins or in archives.
     * 
     * @param uri
     *            {@link org.eclipse.emf.common.util.URI} to verify
     * @return True if the URI targets the {@link com.modelsolv.reprezen.core.workspace.Workspace} else false.
     */
