...
import static com.modelsolv.reprezen.rapidml.util.RapidmlModelUtils.getContainingResourceDefinition
...
import static com.modelsolv.reprezen.rapidml.xtext.loaders.ZenLibraries.IANA_LINK_RELATIONS
import static com.modelsolv.reprezen.rapidml.xtext.loaders.ZenLibraries.PRIMITIVE_TYPES
import static com.modelsolv.reprezen.rapidml.xtext.loaders.ZenLibraries.STANDARD_MEDIA_TYPES
...
import com.modelsolv.reprezen.rapidml.xtext.RapidMLRuntimeModule
import com.modelsolv.reprezen.rapidml.xtext.RapidMLStandaloneSetup
import com.modelsolv.reprezen.rapidml.util.InheritanceUtils
//import com.modelsolv.reprezen.rapidml.xtext.RestApiXtextPlugin;
import com.modelsolv.reprezen.rapidml.xtext.libraries.util.PrimitiveTypes
import com.modelsolv.reprezen.rapidml.xtext.loaders.DslRestModelLoader
import com.modelsolv.reprezen.rapidml.xtext.loaders.RestModelLoader
...
class RapidMLScopeProvider extends AbstractDeclarativeScopeProvider {
	 ...
	 */
	def package IScope scope_PropertyReference_conceptualFeature(com.modelsolv.reprezen.rapidml.URI uri,
		EReference eRef) {
