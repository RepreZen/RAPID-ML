...
public class RestFileValidator {
    ...
    /**
     * Validates a directory and throws a {@link com.modelsolv.reprezen.rapidml.xtext.RestApiException} if invalid.
     * 
     * @param directory
    ...
    /**
     * Validates a file and throws a {@link com.modelsolv.reprezen.rapidml.xtext.RestApiException} if invalid.
     * 
     * @param modelFile
