 ...
 *******************************************************************************/
package com.modelsolv.reprezen.restapi.xtext.libraries.util;
...
public enum PrimitiveTypes {
    ANYURI("anyURI"), DURATION("duration"), BASE64BINARY("base64Binary"), BOOLEAN("boolean"), DATE("date"), DATETIME(
            "dateTime"), DECIMAL("decimal"), DOUBLE("double"), FLOAT("float"), GMONTH("gMonth"), GMONTHDAY("gMonthDay"), GDAY(
            "gDay"), GYEARMONTH("gYearMonth"), GYEAR("gYear"), QNAME("QName"), TIME("time"), STRING("string"), NCNAME(
            "NCName"), INT("int"), INTEGER("integer"), LONG("long");
