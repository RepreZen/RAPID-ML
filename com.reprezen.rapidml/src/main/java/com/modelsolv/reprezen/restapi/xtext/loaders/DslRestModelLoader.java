...
import com.modelsolv.reprezen.restapi.xtext.validation.RestFileValidator;
...
public class DslRestModelLoader implements RestModelLoader {
    ...
    protected com.modelsolv.reprezen.restapi.xtext.validation.RestFileValidator validator;
