...
import static com.modelsolv.reprezen.restapi.RestapiPackage.Literals.COLLECTION_PARAMETER;
import static com.modelsolv.reprezen.restapi.RestapiPackage.Literals.MATRIX_PARAMETER;
import static com.modelsolv.reprezen.restapi.RestapiPackage.Literals.MESSAGE_PARAMETER;
import static com.modelsolv.reprezen.restapi.RestapiPackage.Literals.NAMED_LINK_DESCRIPTOR;
import static com.modelsolv.reprezen.restapi.RestapiPackage.Literals.SERVICE_DATA_RESOURCE;
import static com.modelsolv.reprezen.restapi.xtext.parser.antlr.internal.InternalRapidMLParser.RULE_ID;
...
public class CustomSyntaxErrorMessageProvider extends SyntaxErrorMessageProvider {
    ...
    public SyntaxErrorMessage getSyntaxErrorMessage(IParserErrorContext context) {
        ...
        String wrongName = Strings.toFirstLower(RestapiPackage.eINSTANCE.getZenModel().getName());
