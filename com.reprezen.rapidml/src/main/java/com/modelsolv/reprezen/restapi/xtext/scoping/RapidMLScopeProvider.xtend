...
import static com.modelsolv.reprezen.restapi.util.RestapiModelUtils.getContainingResourceDefinition
...
import static com.modelsolv.reprezen.restapi.xtext.loaders.ZenLibraries.IANA_LINK_RELATIONS
import static com.modelsolv.reprezen.restapi.xtext.loaders.ZenLibraries.PRIMITIVE_TYPES
import static com.modelsolv.reprezen.restapi.xtext.loaders.ZenLibraries.STANDARD_MEDIA_TYPES
...
class RapidMLScopeProvider extends AbstractDeclarativeScopeProvider {
	 ...
	 */
	def package IScope scope_PropertyReference_conceptualFeature(com.modelsolv.reprezen.restapi.URI uri,
		EReference eRef) {
