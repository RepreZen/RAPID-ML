...
import com.reprezen.core.util.EmfUtils;

/**
 * Eclipse implementation for an Eclipse plug-in {@link com.reprezen.core.workspace.Workspace}.
 * 
 * @author jimleroyer
 * @since 2013/04/29
 */
public class EmfWorkspace implements Workspace {
     ...
     * of a plug-in or archive) before calling this method, else a {@link com.reprezen.core.workspace.WorkspaceException}
     * will be thrown.
     * 
     * @param fileUri
     *            File URI to search.
     * @return Found {@link java.io.File} if part of the workspace else {@link com.google.common.base.Absent}
     * @throws {@link com.reprezen.core.workspace.WorkspaceException} If a URI part of a plug-in is provided.
