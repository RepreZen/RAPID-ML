...
public class RestTerminalConverters extends DefaultTerminalConverters {
    ...
    /*
     * Certain keywords, like 'title', are commonly used as property names in data models. Normally, such keywords would
     * need to be prefixed with a ^caret to be declared or referenced as property names. We can allow selected keywords
     * to be used as property names without the caret prefix by making these changes: add the keyword as an alternate to
     * the Keyword rule in XtextDsl.xtext add the keyword to RestTerminalConverters.keywordsAsIdentifiers
     */
    private static final Set<String> keywordsAsIdentifiers = Sets.newHashSet("title");

    /**
     * Copy pasted from {@link Ecore2XtextTerminalConverters} with additional allowing of the "_" as a first character.
     * 
     * @return
     */
