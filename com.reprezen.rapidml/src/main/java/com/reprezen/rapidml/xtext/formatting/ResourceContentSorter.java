...
/**
 * Sorts the contents of a resource definition to achieve the canonical order.
 * <br>
 * 
...
public class ResourceContentSorter {
	 ...
	 *            the parser rule
	 * @return the sets of list element separators for a given grammar element,
	 *         usually they are commas.
	 */
