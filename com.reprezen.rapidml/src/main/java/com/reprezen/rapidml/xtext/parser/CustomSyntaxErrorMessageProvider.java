...
import static com.reprezen.rapidml.RapidmlPackage.Literals.COLLECTION_PARAMETER;
...
public class CustomSyntaxErrorMessageProvider extends SyntaxErrorMessageProvider {
	...
	private SyntaxErrorMessage processNoViableAltException(IParserErrorContext context, String unexpectedText,
		...
		if (currNode != null && currNode.getPreviousSibling() != null) {
			...
			// in most cases NoViableAltException indicate that previous statement not
			// complete or doesnt contains
	...
	/**
	 * An abstract implementation of {@link RepreZenNoViableAltErrorHandler} suited
	 * for errors due to missing element name.
	 */
