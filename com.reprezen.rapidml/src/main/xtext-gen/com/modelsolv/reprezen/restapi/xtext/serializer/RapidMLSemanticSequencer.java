...
public class RapidMLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_PrimitiveTypeSourceReference(ISerializationContext context, PrimitiveTypeSourceReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPrimitiveTypeSourceReferenceAccess().getSimpleTypePrimitiveTypeIDTerminalRuleCall_3_0_1(), semanticObject.eGet(RestapiPackage.Literals.PRIMITIVE_TYPE_SOURCE_REFERENCE__SIMPLE_TYPE, false));
		feeder.finish();
	}
	...
	protected void sequence_PropertyReference(ISerializationContext context, PropertyReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPropertyReferenceAccess().getConceptualFeaturePrimitivePropertyFeatureNameParserRuleCall_3_0_1(), semanticObject.eGet(RestapiPackage.Literals.PROPERTY_REFERENCE__CONCEPTUAL_FEATURE, false));
		feeder.finish();
	}
