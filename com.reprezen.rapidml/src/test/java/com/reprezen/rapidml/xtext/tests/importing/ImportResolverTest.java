...
public class ImportResolverTest {
	...
	public void wildcardModelPathTests() throws URISyntaxException, MalformedURLException {
		...
		testModelPath(modelPath, "a.b.c", null, "x/y/z/Model.rapid", //
				...
				null);
		// repeat above tests but without referencing named wildcards. Tests bug in
		// ModelPathItem$BindingsPruner that
		// was throwing concurrent mod exception. Fixed in
		// 164b0ede937b64a4b566e9f6821833e4b8347d80 and in this change
