...
class ElementOrderSorterTest {
	...
	def Keyword[] objectResourceKeywords() {
		#[grammarAccess.includedPropertiesAccess.propertiesKeyword_2_0_2, grammarAccess.referenceEmbedAccess
                .referenceEmbedKeyword_2, grammarAccess.referenceLinkAccess.referenceLinkKeyword_2,
                grammarAccess.namedLinkDescriptorAccess.linkDescriptorKeyword_3, grammarAccess
                        .objectResourceAccess.mediaTypesKeyword_7_3_3_1, grammarAccess.methodAccess
                        .methodKeyword_3, grammarAccess.inlineExampleAccess.exampleKeyword_2,
	...
	def Keyword[] collectionResourceKeywords() {
		#[grammarAccess.collectionParameterAccess
                .collectionParamKeyword_4, grammarAccess.includedPropertiesAccess
                .propertiesKeyword_2_0_2, grammarAccess.referenceEmbedAccess
                .referenceEmbedKeyword_2, grammarAccess.referenceLinkAccess.referenceLinkKeyword_2,
                grammarAccess.namedLinkDescriptorAccess.linkDescriptorKeyword_3, grammarAccess
                        .collectionResourceAccess.mediaTypesKeyword_7_3_4_1, grammarAccess.methodAccess
                        .methodKeyword_3, grammarAccess.inlineExampleAccess.exampleKeyword_2,
                grammarAccess.externalExampleAccess.externalExampleKeyword_2]
	}
	...
	def assertListEquals(Keyword[] expected, Keyword[] actual) {
        ...
        for (i : 0 ..< expected.size) {
            if (!samePriority.containsKey(expected.get(i)) || !samePriority.containsKey(actual.get(i)) || !samePriority.get(expected.get(i)).equals(samePriority.get(actual.get(i)))) {
    ...
    def assertListOrder(Keyword[] tested, Map<Keyword, Integer> priorityTree) {
        for (i : 0 ..< tested.size-1) {
            if (samePriority.containsKey(tested.get(i)) && samePriority.containsKey(tested.get(i+1)) && samePriority.get(tested.get(i)).equals(samePriority.get(tested.get(i+1)))) {
