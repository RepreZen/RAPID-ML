...
public class XmiSerializerTest {
	...
	public void testModelLoaded() {
		// ZenModel zenModel = XmiModelLoaderUtils.loadModelWithoutWorkspace(new
		// File(modelPath));
	...
	public void testReferencesToMediaTypesLibrary() {
		...
		// assertThat(zenModel, notNullValue());
		//
		// EList<MediaType> mediaTypes =
		// zenModel.getResourceAPIs().get(0).getOwnedResourceDefinitions().get(0)
		// .getMediaTypes();
	...
	public void testReferencesToXsdTypesLibrary() {
		...
		// Structure firstDataType = (Structure)
		// interfaceDatamodel.getOwnedDataTypes().get(0);
		// PrimitiveProperty primitiveProperty = (PrimitiveProperty)
		// firstDataType.getOwnedFeatures().get(0);
